(function() {
    ...
    nfuzion.application.Application = function(name) {
        ...
        if (nfuzion.application.Application.appName !=
            null) throw "Cannot create more than one instance of Application.";
        nfuzion.application.Application.appName = name;
        haxe.Log.trace("Starting " + name + ".", {
            fileName: "Application.hx",
            lineNumber: 53,
            className: "nfuzion.application.Application",
            methodName: "new"
        });
        haxe.Log.trace("Built: " + "2013-12-06 15:50:29", {
            fileName: "Application.hx",
            lineNumber: 54,
            className: "nfuzion.application.Application",
            methodName: "new"
    ...
    nfuzion.application.Application.__name__ =
        ["nfuzion", "application", "Application"];
    ...
    nfuzion.nTactic.NTactic = function(name) {
        nfuzion.application.Application.call(this,
            name);
        this.ready = false;
    ...
    nfuzion.nTactic.NTactic.__name__ =
        ["nfuzion", "nTactic", "NTactic"];
    nfuzion.nTactic.NTactic["goto"] = function(branch, vars, addToHistory) {
        ...
        if (array.length > 1) {
            ...
            if (screenModel != null) screenModel["goto"](array.join("/"), vars, addToHistory);
            else haxe.Log.trace("ERROR: Failed to go to branch on screen model.", {
                fileName: "NTactic.hx",
                lineNumber: 85,
                className: "nfuzion.nTactic.NTactic",
                methodName: "goto"
            })
    ...
    nfuzion.nTactic.NTactic.cacheScreens = function(model, screensToCache) {
        ...
        if (screenModel != null) screenModel.cacheScreens(screensToCache);
        else haxe.Log.trace("ERROR: Failed to cache screen(s). Screen model does not exist", {
            fileName: "NTactic.hx",
            lineNumber: 108,
            className: "nfuzion.nTactic.NTactic",
            methodName: "cacheScreens"
        })
    };
    nfuzion.nTactic.NTactic.releaseScreens = function(model, screensToRelease) {
        var screenModel = nfuzion.nTactic.NTactic.screens.getModel(model);
        if (screenModel != null) screenModel.releaseScreens(screensToRelease);
        else haxe.Log.trace("ERROR: Failed to cache screen(s). Screen model does not exist", {
            fileName: "NTactic.hx",
            lineNumber: 123,
            className: "nfuzion.nTactic.NTactic",
    ...
    nfuzion.nTactic.NTactic.prototype = $extend(nfuzion.application.Application.prototype, {
        ...
        get_ready: function() {
            return nfuzion.nTactic.NTactic.builder.sketch != null && (nfuzion.nTactic.NTactic.builder.sketch.ready && (nfuzion.nTactic.NTactic.screens !=
                null && nfuzion.nTactic.NTactic.storage.ready))
        },
        ready: null,
        onNTacticXmlReady: function(e) {
            ...
            if (nfuzion.nTactic.NTactic.configurationXml == null) {
                haxe.Log.trace("FATAL: 'ntactic.xml' data is null!", {
                    fileName: "NTactic.hx",
                    lineNumber: 183,
                    className: "nfuzion.nTactic.NTactic",
                    methodName: "onNTacticXmlReady"
                });
                return
            }
            var viewportXml =
                nfuzion.nTactic.NTactic.configurationXml.elementsNamed("viewport").next();
            if (viewportXml != null) {
                var width = 800;
                var height = 600;
                var paint = null;
                var widthString = viewportXml.get("width");
                if (widthString == null) haxe.Log.trace("FATAL: Viewport width is not specified in 'ntactic.xml'.", {
                    fileName: "NTactic.hx",
                    lineNumber: 197,
                    className: "nfuzion.nTactic.NTactic",
                    methodName: "onNTacticXmlReady"
                });
                else width = Std.parseInt(widthString);
                var heightString = viewportXml.get("height");
                if (heightString == null) haxe.Log.trace("FATAL: Viewport height is not specified in 'ntactic.xml'.", {
                    fileName: "NTactic.hx",
                    lineNumber: 206,
                    className: "nfuzion.nTactic.NTactic",
                    methodName: "onNTacticXmlReady"
                });
                else height = Std.parseInt(heightString);
                var colorString = viewportXml.get("color");
                if (colorString != null) paint = new nfuzion.paint.Paint("viewport", nfuzion.utility.ColorTools.fromString(colorString));
                else paint = new nfuzion.paint.Paint("viewport", nfuzion.type.Color.black);
                nfuzion.nTactic.NTactic.stage = new nfuzion.graphics.Stage(width, height, paint)
            } else haxe.Log.trace("FATAL: Viewport not specified in 'ntactic.xml'.", {
                fileName: "NTactic.hx",
                lineNumber: 225,
                className: "nfuzion.nTactic.NTactic",
                methodName: "onNTacticXmlReady"
        ...
        assignCacheManager: function(cacheManager) {
            if (cacheManager == null) {
                haxe.Log.trace("WARNING: Intercepted attempt to set property 'cacheManager' to null.", {
                    fileName: "NTactic.hx",
                    lineNumber: 166,
                    className: "nfuzion.nTactic.NTactic",
                    methodName: "assignCacheManager"
                });
                return
            }
    ...
    Reflect.fields = function(o) {
        ...
        if (o != null) {
            ...
            for (var f in o)
                if (f != "__id__" && (f != "hx__closures__" &&
                    hasOwnProperty.call(o, f))) a.push(f)
        }
        return a
    };
    ...
    Type["typeof"] = function(v) {
        ...
        switch (_g) {
            ...
            case "number":
                if (Math.ceil(v) == v % 2147483648) return ValueType.TInt;
        ...
        serialize: function(v) {
            ...
            switch ($e[1]) {
                ...
                case 2:
                    ...
                    else if (!Math.isFinite(v)) this.buf.b += Std.string(v < 0 ? "m" : "p");
                    else {
                        this.buf.b += "d";
                        this.buf.b += Std.string(v)
                    }
                    ...
                    switch (c) {
                        ...
                        case haxe.io.Bytes:
                            ...
                            while (i < max) {
                                ...
                                charsBuf.b += Std.string(b64.charAt((b2 <<
                                    2 | b3 >> 6) & 63));
    ...
    haxe.Unserializer.prototype = {
        unserialize: function() {
            ...
            switch (_g) {
                ...
                case 82:
                    var n = this.readDigits();
                    if (n < 0 ||
                        n >= this.scache.length) throw "Invalid string reference";
                ...
                case 77:
                    ...
                    this.cache.push(h);
                    var buf = this.buf;
                    while (this.buf.charCodeAt(this.pos) !=
                        104) {
                        var s = this.unserialize();
                        h.set(s, this.unserialize())
                    }
        ...
        unserializeEnum: function(edecl, tag) {
            if (this.buf.charCodeAt(this.pos++) !=
                58) throw "Invalid enum format";
    ...
    haxe.ds.ObjectMap.__interfaces__ =
        [IMap];
    ...
    haxe.ds.StringMap.__interfaces__ =
        [IMap];
    ...
    haxe.xml.Parser.doParse = function(str, p, parent) {
            ...
            switch (state) {
                    ...
                    switch (c) {
                        case 33:
                            if (str.charCodeAt(p +
                                ...
                                state = 16;
                                start = p + 1
                            } else if (str.charCodeAt(p + 1) != 45 || str.charCodeAt(p + 2) != 45) throw "Expected \x3c!--";
                            else {
                                p += 2;
                                state = 15;
                                start = p + 1
                ...
                case 18:
                    if (c == 59) {
                        ...
                        } else if (!haxe.xml.Parser.escapes.exists(s)) buf.b += Std.string("&" + s + ";");
                        else buf.b += Std.string(haxe.xml.Parser.escapes.get(s));
                        start = p + 1;
                        state = next
                    }
                    break
        ...
        if (state == 13) {
            if (p != start || nsubs == 0) parent.addChild(Xml.createPCData(buf.b +
            ...
            default:
                if (o != null) {
                    if (typeof cl == "function") {
                        ...
                        if (js.Boot.__interfLoop(o.__class__,
                            cl)) return true
                    }
    ...
    $hxClasses["nfuzion.application.ApplicationMessage"] =
        nfuzion.application.ApplicationMessage;
    ...
    nfuzion.event = {};
    nfuzion.event.IEventDispatcher =
        function() {};
    ...
    nfuzion.event.EventDispatcher.__name__ =
        ["nfuzion", "event", "EventDispatcher"];
    ...
    nfuzion.event.EventDispatcher.prototype = {
        ...
        addEventListener: function(type, listener, priority) {
            ...
            var index = this.getFunctionIndex(listeners, listener);
            if (index < 0)
                if (!this.invertDefaultPriority) listeners.push(listener);
    ...
    nfuzion.builder.Builder.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        themeComponent: function(component, sketchComponent, useBox) {
            ...
            if (useBox) component.setSquare(sketchComponent._x,
                sketchComponent._y, sketchComponent._width, sketchComponent._height);
        ...
        themeChild: function(child, childSketch, useBox) {
            if (useBox == null) useBox = true;
            if (js.Boot.__instanceof(child, nfuzion.graphics.Text)) this.themeText(child,
                childSketch, useBox);
            else if (js.Boot.__instanceof(child, nfuzion.graphics.Container)) this.themeContainer(child, childSketch, useBox);
            else haxe.Log.trace("ERROR: Unknown sketch type '" + Type.getClassName(Type.getClass(child)) + "'.", {
                fileName: "Builder.hx",
                lineNumber: 285,
                className: "nfuzion.builder.Builder",
                methodName: "themeChild"
            })
        },
        ...
        themeContainer: function(container, sketchContainer, useBox) {
            ...
            if (sketchContainer.className != null) {
                ...
                if (classSketch == null) haxe.Log.trace("ERROR: Class '" + className + "' not found.", {
                    fileName: "Builder.hx",
                    lineNumber: 230,
                    className: "nfuzion.builder.Builder",
                    methodName: "themeContainer"
                });
                else {
        ...
        buildText: function(foundation, sketchText) {
            var text = new nfuzion.graphics.Text(sketchText.name,
                sketchText);
            ...
            while (_g < _g1.length) {
                ...
                switch (_g2) {
                    ...
                    case nfuzion.sketch.type.SketchText:
                        ...
                        break;
                    default:
                        haxe.Log.trace("ERROR: Unknown sketch type '" + Type.getClassName(Type.getClass(child)) +
                            "'.", {
                                fileName: "Builder.hx",
                                lineNumber: 180,
                                className: "nfuzion.builder.Builder",
                                methodName: "buildChildren"
                            })
                }
            }
        },
        buildContainer: function(foundation, sketchContainer) {
            ...
            if (sketchContainer.className != null) {
                var className = sketchContainer.className;
                classSketch = this.sketch.getClass(className);
                if (classSketch == null) haxe.Log.trace("ERROR: Class '" +
                    className + "' not found.", {
                        fileName: "Builder.hx",
                        lineNumber: 141,
                        className: "nfuzion.builder.Builder",
        ...
        buildOver: function(className, container) {
            ...
            classSketch = this.sketch.getClass(className);
            if (classSketch == null) {
                haxe.Log.trace("ERROR: Class '" + className + "' not found.", {
                    fileName: "Builder.hx",
                    lineNumber: 101,
                    className: "nfuzion.builder.Builder",
                    methodName: "buildOver"
                });
                return false
            }
            this.configueComponent(container,
                classSketch);
            this.buildChildren(container, classSketch);
            container.sketch = classSketch;
            return true
        ...
        onSketchReady: function(e) {
            if (this.sketch != null && this.sketch.ready) {
                this.sketch.removeEventListener("BuilderEvent.ready",
                    $bind(this, this.onSketchReady));
        ...
        set_sketch: function(sketch) {
            if (sketch != this.sketch) {
                this.sketch = sketch;
                if (sketch.ready) this.onSketchReady();
                else sketch.addEventListener("BuilderEvent.ready", $bind(this, this.onSketchReady))
            }
            return this.sketch
        },
        sketch: null,
    ...
    nfuzion.builder.event.BuilderEvent.__name__ =
        ["nfuzion", "builder", "event", "BuilderEvent"];
    ...
    nfuzion.cache.ListCache.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        ...
        requestCacheRangeData: function() {
            var _g1 = 0,
                _g = this.ranges.length;
            while (_g1 < _g) {
                var i = _g1++;
                var range = this.ranges[i];
                if (range.entries.length < range.end - range.start + 1) {
                    this.addDataRequest(range.start + range.entries.length,
                        range.end);
                    break
                }
            }
        ...
        addCacheRangeData: function(partialList) {
            if (this.ranges.length > 0) {
                ...
                if (index > 0 && this.ranges[index - 1].end >= start) {
                    ...
                    if (start <= previousRange.start + previousRange.entries.length) index--;
                    else {
                        var newEnd = previousRange.end;
                        previousRange.end = start - 1;
                        this.ranges.splice(index, 0, new nfuzion.cache.type.CacheRange(start,
                            newEnd))
                    }
                }
                while (index < this.ranges.length && this.ranges[index].start <= end) {
                    ...
                    while (i <= end) {
                        ...
                        if (i < nextEntry) range.entries[i - range.start] = partialList.entries[i - start];
                        else if (i == nextEntry) {
        ...
        removeCacheRange: function(start, end) {
            if (start <= 0 && end >= this.listLength - 1) {
                ...
                haxe.Log.trace("WARNING: Cannot remove partial cache range.  Removing all.", {
                    fileName: "ListCache.hx",
                    lineNumber: 784,
                    className: "nfuzion.cache.ListCache",
                    methodName: "removeCacheRange"
                });
        ...
        addCacheRange: function(start, end) {
            ...
            if (index >
                0 && this.ranges[index - 1].end >= start) index--;
            var range = this.ranges[index];
            if (range == null || end < range.start) {
                ...
                while (end >= range.start) {
                    ...
                    if (index + 1 >= this.ranges.length) {
                        ...
                        } else this.ranges.splice(index +
                            1, 0, new nfuzion.cache.type.CacheRange(start, end));
                        break
                    } else {
        ...
        onRequestTimeout: function(e) {
            haxe.Log.trace("ERROR: No response received for list request after " +
                this.requestTimer.period + " seconds.", {
                    fileName: "ListCache.hx",
                    lineNumber: 476,
                    className: "nfuzion.cache.ListCache",
                    methodName: "onRequestTimeout"
                });
        ...
        addDataRequest: function(start, end) {
            ...
            if (start < 0 || (end < 0 || end < start)) haxe.Log.trace("WARNING: Request for invalid data range!", {
                fileName: "ListCache.hx",
                lineNumber: 461,
                className: "nfuzion.cache.ListCache",
                methodName: "addDataRequest"
            });
            else {
                ...
                if (this.data == null) {
                    if (this.windowSize > 0) {
                        ...
                        if (this.data.entries.length >
                            0) this.dispatchEvent(new nfuzion.cache.event.CacheEvent("CacheEvent.update", 0, this.listLength - 1));
                        if (start <= end) this.addDataRequest(start, end);
                    ...
                    if (windowStart <= dataEnd)
                        if (windowStart >= dataStart) overlapStart = windowStart;
                        else
                    if (dataStart <= windowEnd) overlapStart = dataStart;
                    var overlapEnd = -1;
                    if (windowEnd >= dataStart)
                        if (windowEnd <= dataEnd) overlapEnd = windowEnd;
                        else
                    if (windowStart <= dataEnd) overlapEnd = dataEnd;
                    ...
                    if (this.listPosition < this.listLength && overlapSize < windowSize) {
                        ...
                        if (requestStart < this.listLength) {
                            ...
                            if (newStart != requestStart) this.dispatchEvent(new nfuzion.cache.event.CacheEvent("CacheEvent.update", this.data.offset, this.data.offset + this.data.entries.length -
                                1));
                            if (newStart <= requestEnd) this.addDataRequest(requestStart, requestEnd);
                            else this.requestData()
                        }
                    } else if (dataEnd < bufferedEnd) {
                        var start = dataEnd + 1;
                        start = this.fillCacheForward(start, bufferedEnd);
                        if (start <= bufferedEnd) this.addDataRequest(start, bufferedEnd);
                        else this.requestData()
                    } else if (bufferedStart < this.data.offset) {
                        this.fillCacheBackward(bufferedStart);
                        if (bufferedStart <= this.data.offset) this.addDataRequest(bufferedStart, dataStart - 1);
                        else this.requestData()
        ...
        fillCacheForward: function(start,
            end) {
            if (end >= this.listLength) end = this.listLength - 1;
        ...
        addData: function(partialList) {
            ...
            if (partialList != null) {
                ...
                if (partialList.offset >=
                    this.listLength) {
                    haxe.Log.trace("WARNING: List received out-of-range data.", {
                        fileName: "ListCache.hx",
                        lineNumber: 180,
                        className: "nfuzion.cache.ListCache",
                        methodName: "addData"
                ...
                if (partialList.offset >= this.listPosition - 20 && partialList.offset + partialList.entries.length <= this.listPosition + this.windowSize + 20) {
                    if (this.data == null || (this.data.offset > partialList.offset + partialList.entries.length || partialList.offset > this.data.offset + this.data.entries.length)) {
                        ...
                        while (i < partialList.offset + mylength) {
                            if (i >= this.data.offset && i < this.data.offset + this.data.entries.length) this.data.entries[i - this.data.offset] = partialList.entries[i - partialList.offset];
                            else this.data.entries.push(partialList.entries[i -
                                partialList.offset]);
                            i++
                        }
                    }
        ...
        set_listPosition: function(listPosition) {
            if (listPosition < 0) {
                haxe.Log.trace("ERROR: Cannot set list position to less than 0.", {
                    fileName: "ListCache.hx",
                    lineNumber: 120,
                    className: "nfuzion.cache.ListCache",
                    methodName: "set_listPosition"
                });
                listPosition = 0
            }
        ...
        set_listLength: function(listLength) {
            if (listLength < 0) {
                haxe.Log.trace("ERROR: Cannot set list length to less than 0.", {
                    fileName: "ListCache.hx",
                    lineNumber: 85,
                    className: "nfuzion.cache.ListCache",
                    methodName: "set_listLength"
                });
                listLength = 0
            }
            if (this.listLength != listLength) {
                if (listLength < this.listLength) {
                    if (this.data.offset + this.data.entries.length >= listLength) {
                        ...
                        if (excess > this.data.entries.length) this.data.entries = new Array;
                        else {
                            var _g =
                                0;
                            while (_g < excess) {
        ...
        set_windowSize: function(windowSize) {
            if (windowSize < 1) {
                haxe.Log.trace("ERROR: Cannot set cache window size to less than 1.", {
                    fileName: "ListCache.hx",
                    lineNumber: 69,
                    className: "nfuzion.cache.ListCache",
                    methodName: "set_windowSize"
                });
                windowSize = 1
            }
        ...
        __properties__: {
            set_bufferSize: "set_bufferSize",
            set_windowSize: "set_windowSize",
            set_listLength: "set_listLength",
            set_listPosition: "set_listPosition",
            set_dataRequester: "set_dataRequester",
            set_dataDismisser: "set_dataDismisser"
        }
    });
    nfuzion.cache.event = {};
    ...
    nfuzion.cache.event.CacheEvent.__name__ = ["nfuzion", "cache",
        "event", "CacheEvent"
    ];
    ...
    nfuzion.client.GhostClient.prototype =
        $extend(nfuzion.event.EventDispatcher.prototype, {
            ...
            __properties__: {
                set_autoConnect: "set_autoConnect"
            }
        });
    ...
    nfuzion.client.WebSocketClient.prototype = $extend(nfuzion.client.Client.prototype, {
        onError: function(message) {
            haxe.Log.trace("ERROR:" + Std.string(message), {
                fileName: "WebSocketClient.hx",
                lineNumber: 191,
                className: "nfuzion.client.WebSocketClient",
                methodName: "onError"
            })
        },
        ...
        onOpen: function(message) {
            this.connected = true;
            this.connectRequested = false;
            if (this.closeRequested) this.disconnect();
            else this.dispatchEvent(new nfuzion.client.event.ClientEvent("ClientEvent.connect", this))
        },
        onTxTimer: function(e) {
            if (this.client.bufferedAmount <= 0) {
                if (this.txQueue.length > 0) try {
                    ...
                    haxe.Log.trace("ERROR: " + Std.string(e1), {
                        fileName: "WebSocketClient.hx",
                        lineNumber: 144,
                        className: "nfuzion.client.WebSocketClient",
                        methodName: "onTxTimer"
                    });
                    this.disconnect()
                }
                this.txTimer.reset()
    ...
    nfuzion.client.event.ClientEvent.prototype =
        $extend(nfuzion.event.Event.prototype, {
            data: null,
            client: null,
    ...
    nfuzion.debug.Debug.__properties__ = {
    ...
    nfuzion.debug.Debug.debugTrace = function(v, inf) {
        var message =
            new nfuzion.message.debug.LetTrace(nfuzion.timer.Delay.now(), nfuzion.application.Application.appName, Std.string(v), inf.fileName, inf.lineNumber, inf.className, inf.methodName);
    ...
    nfuzion.debug.Debug.set_client = function(client) {
        nfuzion.debug.Debug.client =
            client;
        if (!client.get_connected()) client.addEventListener("SpanClientEvent.connect", nfuzion.debug.Debug.onClientConnect);
        else nfuzion.debug.Debug.onClientConnect();
    ...
    $hxClasses["nfuzion.event.BubblingEvent"] =
        nfuzion.event.BubblingEvent;
    ...
    nfuzion.event.ListenerManager.prototype = {
        ...
        swapListener: function(dispatcher, type, listener, priority) {
            ...
            if (listener !=
                null) this.attachListener(dispatcher, type, listener, priority)
        },
        ...
        attachListener: function(dispatcher,
            ...
            } else haxe.Log.trace("ERROR: Attempted to add a listener to a null EventDispatcher.", {
                fileName: "ListenerManager.hx",
                lineNumber: 36,
                className: "nfuzion.event.ListenerManager",
                methodName: "attachListener"
            })
        },
        listeners: null,
    ...
    nfuzion.event.ListenerManagerAndEventDispatcher.__name__ = ["nfuzion",
        "event", "ListenerManagerAndEventDispatcher"
    ];
    ...
    $hxClasses["nfuzion.event.ListenerRecord"] =
        nfuzion.event.ListenerRecord;
    ...
    nfuzion.font.BaseFont.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        ...
        set_weight: function(weight) {
            ...
            if (this.weight != weight) {
                this.weight = weight;
                this.dispatchEvent(new nfuzion.font.event.FontEvent("PaintEvent.change",
                    this));
                this.weightChanged()
            }
            return this.weight
    ...
    nfuzion.font.IFontFace.__name__ =
        ["nfuzion", "font", "IFontFace"];
    ...
    nfuzion.font.BaseFontFace = function(path) {
        ...
        if (!StringTools.endsWith(path, ".ttf")) {
            haxe.Log.trace("ERROR: Invalid font filename: " + path, {
                fileName: "BaseFontFace.hx",
                lineNumber: 23,
                className: "nfuzion.font.BaseFontFace",
                methodName: "new"
            });
            return
        }
    ...
    nfuzion.font.FontFace = function(path) {
        ...
        this.implementation.innerHTML =
            "@font-face" + "{" + "font-family: " + this.name + ";" + "src: url('" + path + "');" + "}";
        this.ready = true
    };
    ...
    $hxClasses["nfuzion.font.FontManager"] =
        nfuzion.font.FontManager;
    ...
    nfuzion.font.FontManager.prototype = {
        ...
        set: function(name, source, size, style, weight) {
            var fontFace = null;
            if (this.fontFaces.exists(source)) fontFace = this.fontFaces.get(source);
            else {
    ...
    nfuzion.font.event.FontEvent.__name__ = ["nfuzion",
        "font", "event", "FontEvent"
    ];
    ...
    nfuzion.font.event.FontFaceEvent.__super__ =
        nfuzion.event.Event;
    ...
    nfuzion.font.type = {};
    nfuzion.font.type.FontStyle = $hxClasses["nfuzion.font.type.FontStyle"] = {
        __ename__: ["nfuzion", "font", "type", "FontStyle"],
        __constructs__: ["normal", "italic"]
    };
    ...
    nfuzion.font.type.FontWeight = $hxClasses["nfuzion.font.type.FontWeight"] = {
        __ename__: ["nfuzion", "font", "type", "FontWeight"],
        __constructs__: ["normal", "bold", "bolder", "lighter", "light"]
    };
    ...
    nfuzion.geometry.RelativeBox = function(x, y, top, bottom) {
        ...
        nfuzion.geometry.Box.call(this,
            x, y, top, bottom)
    };
    ...
    nfuzion.geometry.RelativeBox.prototype = $extend(nfuzion.geometry.Box.prototype, {
        ...
        updateRelativeBox: function() {
            var relativeInUse =
                this.leftIsRelative || (this.rightIsRelative || (this.topIsRelative || this.bottomIsRelative));
        ...
        setBox: function(left, right, top, bottom) {
            ...
            nfuzion.geometry.Box.prototype.setBox.call(this,
        ...
        set_left: function(left) {
            if (!this.pauseRelativeBox) this.leftIsRelative =
                false;
        ...
        __properties__: $extend(nfuzion.geometry.Box.prototype.__properties__, {
            set_relativeLeft: "set_relativeLeft",
            get_relativeLeft: "get_relativeLeft",
            set_relativeRight: "set_relativeRight",
            get_relativeRight: "get_relativeRight",
            set_relativeTop: "set_relativeTop",
            get_relativeTop: "get_relativeTop",
            set_relativeBottom: "set_relativeBottom",
            get_relativeBottom: "get_relativeBottom",
            set_relativeX: "set_relativeX",
            get_relativeX: "get_relativeX",
            set_relativeY: "set_relativeY",
    ...
    nfuzion.graphics.BaseComponent = function(name, sketch) {
        ...
        this.backgroundBox.addEventListener("change", $bind(this,
            this.backgroundBoxChanged));
    ...
    nfuzion.graphics.BaseComponent.prototype =
        $extend(nfuzion.geometry.Box.prototype, {
            ...
            set_layout: function(layout) {
                if (this.layout != layout) {
                    ...
                    if (!this.layout.attach(this)) {
                        layout = null;
                        haxe.Log.trace("Could not attach layout to component '" + this.get_fullName() + "'.", {
                            fileName: "BaseComponent.hx",
                            lineNumber: 926,
                            className: "nfuzion.graphics.BaseComponent",
                            methodName: "set_layout"
                        })
                    }
                }
                return this.layout
            ...
            set_frames: function(frames) {
                if (this.frames != frames) {
                    if (frames != null) {
                        ...
                        while ($it1.hasNext()) {
                            var frame = $it1.next();
                            if (frame.url == null) haxe.Log.trace("frame null on '" + this.get_fullName() + "'", {
                                fileName: "BaseComponent.hx",
                                lineNumber: 769,
                                className: "nfuzion.graphics.BaseComponent",
                                methodName: "set_frames"
                            });
                            this.addImage(frame.url)
                        }
                    } else this.frames = null; if (this.currentFrame != null && frames != null) this["goto"](this.currentFrame)
                }
                return this.frames
            },
            frames: null,
                ...
                if (this.maskImage == null || maskUrl != this.maskUrl) {
                    ...
                    if (maskUrl != null) {
                        ...
                        if (this.maskImage != null)
                            if (this.maskImage.ready) this.maskImageReady();
                            else this.maskImage.addEventListener("ImageEvent.ready", $bind(this, this.maskImageReady))
                    }
                }
                return this.maskUrl
            },
            ...
            backgroundImageReady: function(e) {
                if (e != null) e.target.removeEventListener("ImageEvent.ready", $bind(this,
                    this.backgroundImageReady))
            },
                ...
                if (this.backgroundImage == null || backgroundUrl != this.backgroundUrl) {
                    ...
                    if (backgroundUrl != null) {
                        ...
                        if (this.backgroundImage != null)
                            if (this.backgroundImage.ready) this.backgroundImageReady();
                            else this.backgroundImage.addEventListener("ImageEvent.ready",
                                $bind(this, this.backgroundImageReady))
                    }
                }
            ...
            destroy: function() {
                ...
                if (this.maskImage !=
                    null) this.maskImage.removeEventListener("ImageEvent.ready", $bind(this, this.maskImageReady));
                if (this.parent != null) {
            ...
            disusePaint: function(paint) {
                if (paint !=
                    null) paint.removeEventListener("PaintEvent.change", $bind(this, this.onPaintChange))
            },
            ...
            bubbleEvent: function(e) {
                ...
                do {
                    ...
                    (!e.stop && (!e.stopNow && component != null)))
            },
            copy: function(from) {
            ...
            clone: function() {
                haxe.Log.trace("ERROR: Cannot clone BaseComponent.", {
                    fileName: "BaseComponent.hx",
                    lineNumber: 405,
                    className: "nfuzion.graphics.BaseComponent",
                    methodName: "clone"
            ...
            set_imposeTouchDisabled: function(imposeTouchDisabled) {
                if (imposeTouchDisabled !=
                    this.imposeTouchDisabled) {
            ...
            set_defaultFrame: function(name) {
                if (name != null)
                    if (!this.frames.exists(name)) {
                        haxe.Log.trace("WARNING: Attempted to set a default frame that doesn't exist", {
                            fileName: "BaseComponent.hx",
                            lineNumber: 353,
                            className: "nfuzion.graphics.BaseComponent",
                            methodName: "set_defaultFrame"
                        });
                        name = null
                    }
            ...
            get_stage: function() {
                if (this.parent !=
                    null) return this.parent.get_stage();
                return null
            },
            stage: null,
            orphan: function() {
            ...
            __properties__: $extend(nfuzion.geometry.Box.prototype.__properties__, {
                ...
                get_globalPosition: "get_globalPosition",
                set_screen: "set_screen",
                set_defaultFrame: "set_defaultFrame",
                set_touchEnabled: "set_touchEnabled",
                set_imposeTouchDisabled: "set_imposeTouchDisabled",
                set_backgroundUrl: "set_backgroundUrl",
                set_backgroundFit: "set_backgroundFit",
                set_backgroundPaint: "set_backgroundPaint",
                set_borderPaint: "set_borderPaint",
                set_borderWidth: "set_borderWidth",
                set_maskUrl: "set_maskUrl",
                set_maskFit: "set_maskFit",
                set_frames: "set_frames",
                set_guises: "set_guises",
                set_guise: "set_guise",
                get_fullName: "get_fullName",
                set_xScale: "set_xScale",
                set_yScale: "set_yScale",
                set_layout: "set_layout",
                get_finalXScale: "get_finalXScale",
                get_finalYScale: "get_finalYScale",
    ...
    nfuzion.graphics.Component.prototype = $extend(nfuzion.graphics.BaseComponent.prototype, {
        ...
        updateBackground: function(e) {
            if (!this.initialized ||
                (this.implementation == null || this.backgroundDiv == null)) return;
                ...
                if (this.backgroundImage != null) {
                    ...
                    switch (_g.backgroundFit[1]) {
                        case 0:
                            ...
                            this.backgroundDiv.style.webkitTransform =
                                null;
                            break;
                        case 2:
                            throw "Not implemented.";
                        ...
                        case 7:
                            ...
                            this.backgroundDiv.style.webkitTransform = "scale(" +
                                Std.string(xScale) + ", " + Std.string(yScale) + ")";
        ...
        updateBorder: function() {
            ...
            if (this.borderPaint != null && this.borderWidth > 0) this.borderDiv.style.border = this.borderWidth + "px solid #" +
                nfuzion.utility.ColorTools.toString(this.borderPaint.color);
            else this.borderDiv.style.border = null
        },
        borderWidthChanged: function() {
            if (this.borderWidth > 0 && this.borderDiv == null) {
                ...
                if (this.implementation.firstChild != null) this.implementation.insertBefore(this.borderDiv, this.implementation.firstChild);
                else this.implementation.appendChild(this.borderDiv)
            }
        ...
        backgroundPaintChanged: function() {
            if (this.backgroundPaint != null) this.implementation.style.backgroundColor = "#" + nfuzion.utility.ColorTools.toString(this.backgroundPaint.color);
            else this.implementation.style.backgroundColor = null
        },
        backgroundFitChanged: function() {
        ...
        backgroundUrlChanged: function() {
            if (this.backgroundDiv ==
                ...
                if (this.implementation.firstChild != null) this.implementation.insertBefore(this.backgroundDiv, this.implementation.firstChild);
                else this.implementation.appendChild(this.backgroundDiv)
            }
        },
        backgroundBoxChanged: function(e) {
            this.updateBackground()
        ...
        visibleChanged: function() {
            this.implementation.style.display =
        ...
        updateTouchEnabled: function() {
            ...
            if (this.touchEnabled && !this.imposeTouchDisabled) this.implementation.style.pointerEvents = "auto";
            else this.implementation.style.pointerEvents = null
        },
        imposeTouchDisabledChanged: function() {
        ...
        updateTransform: function() {
            ...
            this.implementation.style.webkitTransform =
                transformString
        },
        positionChanged: function() {
        ...
        heightChanged: function() {
            ...
            if (this._height >= 0) {
                ...
                this.updateTransform();
                this.implementation.style.height =
                    Std.string(Math.round(-this._height)) + "px"
        ...
        yChanged: function() {
            ...
            if (!this.vFlipped) this.yTransform = Std.string(this._y - this._height * (1 - this.yScale) / 2);
            else this.yTransform = Std.string(this._y + this._height + this._height * (1 - this.yScale) / 2)
        },
        widthChanged: function() {
        ...
        xChanged: function() {
            ...
            if (!this.hFlipped) this.xTransform = Std.string(this._x - this._width * (1 - this.xScale) / 2);
            else this.xTransform = Std.string(this._x + this._width * this.xScale)
        },
        create: function() {
        ...
        removedFromStage: function() {
            ...
            if (this.get_stage() == null && this.onStage) {
                this.implementation.removeEventListener("touchenter", $bind(this, this.onTouchEnter),
                    false);
    ...
    nfuzion.graphics.Container.prototype = $extend(nfuzion.graphics.Component.prototype, {
        ...
        getChildAt: function(index) {
            if (index >=
                0 && index < this.children.length) return this.children[index];
            return null
        },
        ...
        __properties__: $extend(nfuzion.graphics.Component.prototype.__properties__, {
    ...
    $hxClasses["nfuzion.graphics.IText"] =
        nfuzion.graphics.IText;
    ...
    nfuzion.graphics.Stage = function(width, height, paint) {
        ...
        if (($_ = js.Browser.window, $bind($_, $_.requestAnimationFrame)) != null) this.requestAnimationFrame = ($_ = js.Browser.window, $bind($_, $_.requestAnimationFrame));
        else if (window.webkitRequestAnimationFrame != null) this.requestAnimationFrame = $bind(this, this.webkitRequestAnimationFrame);
        else if (window.mozRequestAnimationFrame != null) this.requestAnimationFrame = window.mozRequestAnimationFrame
    };
    ...
    nfuzion.graphics.Stage.prototype =
        $extend(nfuzion.graphics.Container.prototype, {
            set_visible: function(visible) {
            ...
            addEventListener: function(type, listener, priority) {
                if (priority == null) priority = 0;
                nfuzion.graphics.Container.prototype.addEventListener.call(this,
                    type, listener, priority);
                if (type == "paint")
                    if (!this.animating) {
                        this.animating = true;
            ...
            getComponent: function(implementation) {
                ...
                do {
                    ...
                    if (component == null)
                        if (js.Boot.__instanceof(implementation.parentNode, HTMLDivElement)) implementation = implementation.parentNode;
                        else implementation = null
                } while (implementation != null && component == null);
                if (component !=
                    null)
                    while (!component.touchEnabled && component != this.get_stage()) component = component.parent;
                return component
            },
            onMouseUp: function(e) {
                if (!this.touchActive && e.button == 0) {
                    ...
                    component.bubbleEvent(new nfuzion.graphics.event.TouchEvent("end", component, -1, new nfuzion.geometry.Point(e.clientX,
                        e.clientY)))
                }
            },
            ...
            initialize: function() {
                this.implementation.addEventListener("touchstart",
                    $bind(this, this.onTouchStart), false);
    ...
    nfuzion.graphics.Text.__name__ = ["nfuzion",
        "graphics", "Text"
    ];
    ...
    nfuzion.graphics.Text.prototype = $extend(nfuzion.graphics.Component.prototype, {
        ...
        onPaintChange: function(e) {
            nfuzion.graphics.Component.prototype.onPaintChange.call(this,
                e);
            var paint = e.target;
        ...
        set_wrap: function(wrap) {
            if (wrap != this.wrap) {
                this.wrap = wrap;
                if (wrap) this.implementation.style.whiteSpace = "normal";
                else this.implementation.style.whiteSpace = "nowrap"
            }
            return this.wrap
        },
        wrap: null,
        set_font: function(font) {
            ...
            } else haxe.Log.trace("ERROR: Cannot set font to null.", {
                fileName: "Text.hx",
                lineNumber: 132,
                className: "nfuzion.graphics.Text",
                methodName: "set_font"
            });
            return this.font
        },
    ...
    nfuzion.graphics.event.ComponentEvent.__name__ = ["nfuzion", "graphics", "event",
        "ComponentEvent"
    ];
    ...
    nfuzion.graphics.event.StageEvent.__name__ = ["nfuzion", "graphics", "event",
        "StageEvent"
    ];
    ...
    nfuzion.graphics.type.Fit =
        $hxClasses["nfuzion.graphics.type.Fit"] = {
            __ename__: ["nfuzion", "graphics", "type", "Fit"],
            __constructs__: ["none", "coverAll", "containAll", "stretchAll", "tileAll", "cover", "contain", "stretch", "tile"]
    };
    ...
    nfuzion.graphics.type.Fit.tile =
        ["tile", 8];
    ...
    nfuzion.image.ImageLoader = function(url, component, fit, timeout) {
        ...
        this.complete = false;
        this.tinyUrl = HxOverrides.substr(url,
            url.lastIndexOf("/") + 1, null);
        this.load()
    };
    ...
    nfuzion.image.ImageLoader.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        destroy: function() {
            ...
            if (this.image != null) {
                this.image.removeEventListener("ImageEvent.ready", $bind(this,
                    this.onImageEvent));
        ...
        onImageEvent: function(e) {
            ...
            if (e.type == "ImageEvent.ready") this.setImage();
    ...
    nfuzion.image.event = {};
    nfuzion.image.event.ImageEvent = function(type,
        target) {
        nfuzion.event.Event.call(this, type);
        this.target = target
    };
    ...
    $hxClasses["nfuzion.layout.ILayout"] =
        nfuzion.layout.ILayout;
    ...
    nfuzion.layout.BaseLayout.prototype = $extend(nfuzion.event.ListenerManagerAndEventDispatcher.prototype, {
        ...
        attach: function(component) {
            if (component == null) haxe.Log.trace("ERROR: Cannot attach a null component to a layout.", {
                fileName: "BaseLayout.hx",
                lineNumber: 20,
                className: "nfuzion.layout.BaseLayout",
                methodName: "attach"
            });
    ...
    nfuzion.layout.SnapParentEdges.prototype = $extend(nfuzion.layout.BaseLayout.prototype, {
        ...
        update: function() {
            if (this.component.parent != null) {
                this.detachListener(this.component,
                    "change", $bind(this, this.onBoxChanged));
                this.apply();
        ...
        onOrphaning: function(e) {
            this.detachListener(this.component.parent,
                "changeSize", $bind(this, this.onSizeChanged))
        },
        componentAttached: function() {
    ...
    nfuzion.lingo.JsonLingo = function(alphabeticalOrder,
        pad, lineEnd, impliedClassPrefix) {
    ...
    nfuzion.lingo.JsonLingo.prototype = {
        ...
        arrayFrom: function(serial, array, itemClass) {
            while (!this.closesWith(serial, "]")) {
                ...
                if (serial != null) array.push(transport.item);
                else return null;
                serial = this.trimComma(serial)
            }
            return serial
        },
        propertyFrom: function(serial,
            parentInstance, propertyClassArray) {
            var name = this.getQuotedString(serial);
            serial = this.trimToChar(serial, ":");
            if (serial == null) {
                haxe.Log.trace("Property name not followed by ':'", {
                    fileName: "JsonLingo.hx",
                    lineNumber: 387,
                    className: "nfuzion.lingo.JsonLingo",
                    methodName: "propertyFrom"
                });
                return null
            }
            var propertyType = this.getValueType(serial);
            if (propertyType == null) {
                haxe.Log.trace("Could not determine type of property: '" + name + "'", {
                    fileName: "JsonLingo.hx",
                    lineNumber: 394,
                    className: "nfuzion.lingo.JsonLingo",
                    methodName: "propertyFrom"
            ...
            if (propertyClassArray == null) {
                haxe.Log.trace("Failed to get property class array.", {
                    fileName: "JsonLingo.hx",
                    lineNumber: 405,
                    className: "nfuzion.lingo.JsonLingo",
                    methodName: "propertyFrom"
            ...
            switch (propertyClass) {
                case Array:
                    if (propertyType == nfuzion.lingo.type.PropertyType.array) {
                        ...
                        serial = this.trimToChar(serial, "]");
                        if (serial == null) {
                            haxe.Log.trace("Error parsing array.", {
                                fileName: "JsonLingo.hx",
                                lineNumber: 425,
                                className: "nfuzion.lingo.JsonLingo",
                                methodName: "propertyFrom"
                        ...
                        haxe.Log.trace("Message type and class do not match.", {
                            fileName: "JsonLingo.hx",
                            lineNumber: 432,
                            className: "nfuzion.lingo.JsonLingo",
                            methodName: "propertyFrom"
                ...
                case Bool:
                    ...
                    if (value) serial = HxOverrides.substr(serial, 4, null);
                    else serial = HxOverrides.substr(serial, 5, null);
                    break;
                case Int:
                ...
                default:
                    switch (propertyType[1]) {
                        case 4:
                            ...
                            if (instance == null) {
                                haxe.Log.trace("Failed to create class.", {
                                    fileName: "JsonLingo.hx",
                                    lineNumber: 485,
                                    className: "nfuzion.lingo.JsonLingo",
                                    methodName: "propertyFrom"
                        ...
                        case 3:
                            ...
                            break;
                        default:
                            haxe.Log.trace('Unhandled type "' + Std.string(propertyType) + '" in class.', {
                                fileName: "JsonLingo.hx",
                                lineNumber: 493,
                                className: "nfuzion.lingo.JsonLingo",
                                methodName: "propertyFrom"
        ...
        getValueType: function(serial) {
            ...
            switch (_g) {
                ...
                case "f":
                    type =
                        nfuzion.lingo.type.PropertyType["boolean"];
                    break;
                case '"':
        ...
        trimToChar: function(serial, $char) {
            if (serial != null) {
                ...
                if (index >= 0) return HxOverrides.substr(serial,
                    index + 1, null)
            }
            return null
        },
        ...
        from: function(serializedMessage) {
            ...
            if (serializedMessage.charAt(0) == "{") {
                if (serializedMessage.length - serializedMessage.lastIndexOf("}") > 2) haxe.Log.trace("WARNING: Data possibly being ignored in serialized message", {
                    fileName: "JsonLingo.hx",
                    lineNumber: 185,
                    className: "nfuzion.lingo.JsonLingo",
                    methodName: "from"
            ...
            if (serializedMessage == null) {
                haxe.Log.trace("Root element is not an object.", {
                    fileName: "JsonLingo.hx",
                    lineNumber: 216,
                    className: "nfuzion.lingo.JsonLingo",
                    methodName: "from"
            ...
            if (!this.closesWith(serializedMessage, "}")) {
                haxe.Log.trace("Root object does not have closing bracket..", {
                    fileName: "JsonLingo.hx",
                    lineNumber: 224,
                    className: "nfuzion.lingo.JsonLingo",
                    methodName: "from"
            ...
            if (serializedMessage.length > 0) {
                haxe.Log.trace("Extra data found in serialized message.", {
                    fileName: "JsonLingo.hx",
                    lineNumber: 234,
                    className: "nfuzion.lingo.JsonLingo",
                    methodName: "from"
        ...
        propertyTo: function(property, propertyName, padding) {
            ...
            switch ($e[1]) {
                ...
                case 7:
                    var e = $e[2];
                    serializedProperty +=
                        fieldName + '"' + Std.string(property) + '"';
                    break;
                case 6:
                    var c = $e[2];
                    if (js.Boot.__instanceof(property, String)) serializedProperty += fieldName + '"' + StringTools.urlEncode(Std.string(property)) + '"';
                    else if (js.Boot.__instanceof(property, Array)) {
                        if (fieldName != "") serializedProperty += fieldName + this.lineEnd + padding + this.pad + "[";
                    ...
                    } else if (js.Boot.__instanceof(property, nfuzion.message.generic.type.TypeClass)) serializedProperty += this.classTo(property, propertyName, padding + this.pad);
                    else;
                    break;
                case 3:
        ...
        classTo: function(instance, instanceName, padding) {
            ...
            if (!StringTools.startsWith(instanceClassName, this.impliedClassPrefix)) {
                haxe.Log.trace("Unexpected message class namespace.", {
                    fileName: "JsonLingo.hx",
                    lineNumber: 54,
                    className: "nfuzion.lingo.JsonLingo",
                    methodName: "classTo"
            ...
            if (instanceName != "") serializedClass += '"' +
                (instanceName == null ? instanceClassName : instanceName) + '":' + this.lineEnd + padding + "{" + this.lineEnd;
            else serializedClass += "{" + this.lineEnd;
    ...
    nfuzion.lingo.XmlLingo = function(alphabeticalOrder, pad, lineEnd, impliedClassPrefix) {
        if (impliedClassPrefix == null) impliedClassPrefix =
            "nfuzion.message.";
        if (lineEnd == null) lineEnd = "\n";
        if (pad == null) pad = "  ";
        if (alphabeticalOrder == null) alphabeticalOrder = true;
    ...
    nfuzion.lingo.XmlLingo.prototype = {
        extractPropertyValue: function(string) {
            string =
                HxOverrides.substr(string, 0, string.indexOf(">"));
        ...
        arrayFrom: function(tagStarts, array, itemClass) {
            var result = true;
            while (tagStarts[0].charAt(0) != "/")
                if (StringTools.startsWith(tagStarts[0], "item ")) {
                    var transport = {
                        item: null
                    };
                    if (this.propertyFrom(tagStarts, transport, itemClass.slice())) array.push(transport.item);
                    else {
                        result = false;
                        break
                    }
                } else {
                    haxe.Log.trace("None item tag found in an array.", {
                        fileName: "XmlLingo.hx",
                        lineNumber: 388,
                        className: "nfuzion.lingo.XmlLingo",
                        methodName: "arrayFrom"
                    });
                    result = false;
                    break
                }
        ...
        propertyFrom: function(tagStarts, parentInstance, propertyClassArray) {
            ...
            if (start == null) {
                haxe.Log.trace("ERROR: start is null!", {
                    fileName: "XmlLingo.hx",
                    lineNumber: 272,
                    className: "nfuzion.lingo.XmlLingo",
                    methodName: "propertyFrom"
            ...
            switch (propertyClass) {
                case Array:
                    if (propertyType ==
                        nfuzion.lingo.type.PropertyType.array) {
                        var array = new Array;
                ...
                default:
                    switch (propertyType[1]) {
                        ...
                        case 3:
                            ...
                            break;
                        default:
                            haxe.Log.trace('Unhandled type "' + Std.string(propertyType) +
                                '" in class.', {
                                    fileName: "XmlLingo.hx",
                                    lineNumber: 341,
                                    className: "nfuzion.lingo.XmlLingo",
        ...
        propertiesFrom: function(tagStarts, instance) {
            while (tagStarts.length > 0 && !StringTools.startsWith(tagStarts[0], "/"))
                if (!this.propertyFrom(tagStarts, instance)) return false;
            return true
        },
        from: function(serializedMessage) {
            if (serializedMessage == null) {
                haxe.Log.trace("ERROR: Serialized message is null!", {
                    fileName: "XmlLingo.hx",
                    lineNumber: 172,
                    className: "nfuzion.lingo.XmlLingo",
                    methodName: "from"
            ...
            if (serializedMessage == "") {
                haxe.Log.trace("ERROR: Serialized message is empty!", {
                    fileName: "XmlLingo.hx",
                    lineNumber: 177,
                    className: "nfuzion.lingo.XmlLingo",
                    methodName: "from"
            ...
            if (!emptyMessage) {
                ...
                if (end != null) {
                    if (!StringTools.startsWith(end, "/" + partialClassName + ">")) {
                        haxe.Log.trace("Root tag does not match.", {
                            fileName: "XmlLingo.hx",
                            lineNumber: 231,
                            className: "nfuzion.lingo.XmlLingo",
                            methodName: "from"
                    ...
                    haxe.Log.trace("Extraneous data found in serialized message.", {
                        fileName: "XmlLingo.hx",
                        lineNumber: 244,
                        className: "nfuzion.lingo.XmlLingo",
                        methodName: "from"
        ...
        propertyTo: function(property, propertyName, padding) {
            ...
            switch ($e[1]) {
                ...
                case 2:
                    serializedProperty +=
                        padding + this.pad + "<" + propertyName + ' type="' + Std.string(nfuzion.lingo.type.PropertyType.number) + '">' + Std.string(property) + "</" + propertyName + ">" + this.lineEnd;
                    break;
                case 7:
                    var e = $e[2];
                ...
                case 6:
                    var c = $e[2];
                    if (js.Boot.__instanceof(property, String)) serializedProperty += padding + this.pad + "<" + propertyName + ' type="' + Std.string(nfuzion.lingo.type.PropertyType.string) +
                        '">' + StringTools.htmlEscape(Std.string(property)) + "</" + propertyName + ">" + this.lineEnd;
                    else if (js.Boot.__instanceof(property, Array)) {
                    ...
                    } else if (js.Boot.__instanceof(property,
                        nfuzion.message.generic.type.TypeClass)) serializedProperty += this.classTo(property, propertyName, padding + this.pad);
                    else haxe.Log.trace("Detected class does not extend TypeClass.  Property will not be serialized.", {
                        fileName: "XmlLingo.hx",
                        lineNumber: 142,
                        className: "nfuzion.lingo.XmlLingo",
                        methodName: "propertyTo"
                    });
                    break;
                case 3:
                    serializedProperty += padding + this.pad + "<" + propertyName + ' type="' + Std.string(nfuzion.lingo.type.PropertyType["boolean"]) + '">' + (property == true ? "true" : "false") + "</" + propertyName + ">" +
                        this.lineEnd;
                    break;
                default:
            }
        ...
        classTo: function(instance, instanceName, padding) {
            ...
            var instanceClassName = Type.getClassName(instanceClass);
            if (!StringTools.startsWith(instanceClassName, this.impliedClassPrefix)) {
                haxe.Log.trace("Unknown class type.", {
                    fileName: "XmlLingo.hx",
                    lineNumber: 55,
                    className: "nfuzion.lingo.XmlLingo",
                    methodName: "classTo"
            ...
            instanceClassName = HxOverrides.substr(instanceClassName,
                this.impliedClassPrefix.length, null);
            if (instanceName == null) serializedClass += padding + "<" + instanceClassName + ">" + this.lineEnd;
            else serializedClass += padding + "<" + instanceName + (padding == "" ? ">" : ' type="' + Std.string(nfuzion.lingo.type.PropertyType.structure) + '">') + this.lineEnd;
            var propertyNames = Type.getInstanceFields(instanceClass);
            propertyNames.sort($bind(this, this.sortString));
            var _g = 0;
            while (_g < propertyNames.length) {
            ...
            if (instanceName == null) serializedClass += padding + "</" + instanceClassName + ">";
            else serializedClass += padding + "</" + instanceName + ">" + this.lineEnd;
            return serializedClass
        },
        to: function(instance) {
    ...
    nfuzion.lingo.type = {};
    nfuzion.lingo.type.PropertyType = $hxClasses["nfuzion.lingo.type.PropertyType"] = {
        __ename__: ["nfuzion", "lingo", "type", "PropertyType"],
        __constructs__: ["array", "boolean", "number", "string", "structure"]
    };
    ...
    nfuzion.lingo.type.PropertyType.number =
        ["number", 2];
    ...
    nfuzion.loader.TextLoader.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        onError: function() {
            if (this.hasEventListener("LoaderEvent.error")) this.dispatchEvent(new nfuzion.loader.event.LoaderEvent("LoaderEvent.error", this));
            else haxe.Log.trace("ERROR: Failed to load file at '" + this.url + "'.", {
                fileName: "TextLoader.hx",
                lineNumber: 126,
                className: "nfuzion.loader.TextLoader",
                methodName: "onError"
            })
        },
        onReady: function() {
            this.ready = true;
            this.dispatchEvent(new nfuzion.loader.event.LoaderEvent("LoaderEvent.ready",
                this))
        },
    ...
    nfuzion.loader.event.LoaderEvent.__name__ =
        ["nfuzion", "loader", "event", "LoaderEvent"];
    ...
    nfuzion.message.generic.base.Base.__name__ = ["nfuzion",
        "message", "generic", "base", "Base"
    ];
    nfuzion.message.generic.base.Base.prototype = {
        getPropertyType: function(name) {
            ...
            haxe.Log.trace("WARNING: Class appears to not have a field named '" + name + "'.", {
                fileName: "Base.hx",
                lineNumber: 32,
                className: "nfuzion.message.generic.base.Base",
    ...
    nfuzion.message.generic.templates.MessageClass.prototype =
        $extend(nfuzion.message.generic.base.Base.prototype, {
    ...
    nfuzion.message.chime.type.Chime = $hxClasses["nfuzion.message.chime.type.Chime"] = {
        __ename__: ["nfuzion", "message", "chime", "type", "Chime"],
        __constructs__: ["uiConfirm", "uiCancel", "uiNotice", "warning", "turnSignalClick"]
    };
    nfuzion.message.chime.type.Chime.uiConfirm = ["uiConfirm", 0];
    nfuzion.message.chime.type.Chime.uiConfirm.toString =
        $estr;
    ...
    nfuzion.message.chime.type.Chime.warning =
        ["warning", 3];
    ...
    nfuzion.message.debug.LetTrace.__name__ =
        ["nfuzion", "message", "debug", "LetTrace"];
    ...
    $hxClasses["nfuzion.message.generic.templates.Get"] =
        nfuzion.message.generic.templates.Get;
    ...
    nfuzion.message.generic.templates.LetFloat =
        function(value) {
            nfuzion.message.generic.templates.Let.call(this);
            this.value = value
    };
    ...
    nfuzion.message.generic.templates.SetBool.prototype =
        $extend(nfuzion.message.generic.templates.Set.prototype, {
            value: null,
    ...
    nfuzion.message.generic.templates.SetFloat.__super__ =
        nfuzion.message.generic.templates.Set;
    ...
    nfuzion.message.generic.templates.SetString.__name__ = ["nfuzion",
        "message", "generic", "templates", "SetString"
    ];
    ...
    nfuzion.message.leap.type.Phase = $hxClasses["nfuzion.message.leap.type.Phase"] = {
        __ename__: ["nfuzion", "message", "leap",
            "type", "Phase"
        ],
        __constructs__: ["start", "change", "end"]
    };
    ...
    nfuzion.message.leap.type.Phase.end.toString =
        $estr;
    ...
    nfuzion.message.leap.type.Gesture = $hxClasses["nfuzion.message.leap.type.Gesture"] = {
        __ename__: ["nfuzion", "message", "leap", "type", "Gesture"],
        __constructs__: ["oneFingerSwipeLeft", "oneFingerSwipeRight", "oneFingerSwipeUp", "oneFingerSwipeDown", "twoFingerSwipeLeft", "twofingerSwipeRight", "twoFingerSwipeUp", "twoFingerSwipeDown", "dismiss", "beckon"]
    };
    nfuzion.message.leap.type.Gesture.oneFingerSwipeLeft = ["oneFingerSwipeLeft", 0];
    nfuzion.message.leap.type.Gesture.oneFingerSwipeLeft.toString =
        $estr;
    ...
    nfuzion.message.leap.type.Gesture.oneFingerSwipeUp.__enum__ =
        nfuzion.message.leap.type.Gesture;
    ...
    nfuzion.message.leap.type.Gesture.twoFingerSwipeDown =
        ["twoFingerSwipeDown", 7];
    ...
    nfuzion.message.leap.type.Gesture.beckon.__enum__ =
        nfuzion.message.leap.type.Gesture;
    ...
    nfuzion.message.leap.LetRotate.prototype =
        $extend(nfuzion.message.generic.templates.Let.prototype, {
            fingerCount: null,
            deltaAngle: null,
    ...
    nfuzion.message.leap.LetScroll.__name__ =
        ["nfuzion", "message", "leap", "LetScroll"];
    ...
    nfuzion.message.magic.type.Phase = $hxClasses["nfuzion.message.magic.type.Phase"] = {
        __ename__: ["nfuzion", "message", "magic", "type", "Phase"],
        __constructs__: ["start", "change", "end"]
    };
    ...
    nfuzion.message.magic.type.Phase.end =
        ["end", 2];
    ...
    nfuzion.message.media.type.ItemType = $hxClasses["nfuzion.message.media.type.ItemType"] = {
        __ename__: ["nfuzion", "message", "media", "type", "ItemType"],
        __constructs__: ["partition", "folder", "file", "category", "artist", "album", "genre", "composer", "track", "playlist", "audiobook", "chapter", "podcast", "episode"]
    };
    nfuzion.message.media.type.ItemType.partition =
        ["partition", 0];
    ...
    nfuzion.message.media.type.ItemType.file.__enum__ =
        nfuzion.message.media.type.ItemType;
    ...
    nfuzion.message.media.type.ItemType.composer.__enum__ =
        nfuzion.message.media.type.ItemType;
    ...
    nfuzion.message.media.type.ItemType.audiobook = ["audiobook",
        10
    ];
    ...
    nfuzion.message.media.type.ItemType.podcast.__enum__ =
        nfuzion.message.media.type.ItemType;
    ...
    nfuzion.message.navigation.LetDistance.prototype =
        $extend(nfuzion.message.generic.templates.LetFloat.prototype, {
    ...
    nfuzion.message.navigation.LetDistancePercentage.__super__ =
        nfuzion.message.generic.templates.LetFloat;
    ...
    nfuzion.message.navigation.type.TargetType = $hxClasses["nfuzion.message.navigation.type.TargetType"] = {
        __ename__: ["nfuzion", "message", "navigation", "type", "TargetType"],
        __constructs__: ["left", "right", "bearLeft", "bearRight", "uturn", "destination",
            "continueAhead"
        ]
    };
    ...
    nfuzion.message.navigation.type.TargetType.bearLeft =
        ["bearLeft", 2];
    ...
    nfuzion.message.navigation.type.TargetType.uturn.toString =
        $estr;
    ...
    nfuzion.message.navigation.type.StepData.__name__ =
        ["nfuzion", "message", "navigation", "type", "StepData"];
    ...
    nfuzion.message.navigation.type.SerializablePoint =
        function(x, y) {
            if (y == null) y = 0;
            if (x == null) x = 0;
            nfuzion.message.generic.type.TypeClass.call(this);
    ...
    nfuzion.message.navigation.type.SerializablePoint.prototype =
        $extend(nfuzion.message.generic.type.TypeClass.prototype, {
            y: null,
            x: null,
            __class__: nfuzion.message.navigation.type.SerializablePoint
        });
    nfuzion.message.navigation.type.TransitType = $hxClasses["nfuzion.message.navigation.type.TransitType"] = {
        __ename__: ["nfuzion", "message", "navigation", "type", "TransitType"],
        __constructs__: ["walking", "driving"]
    };
    ...
    nfuzion.message.navigation.type.TransitType.walking.__enum__ =
        nfuzion.message.navigation.type.TransitType;
    ...
    nfuzion.message.navigation.type.Step = function(distance, sp, ep, track, text, type) {
        ...
        nfuzion.message.generic.type.TypeClass.call(this);
        this.distance = distance;
        if (sp == null) this.startingPoint =
            new nfuzion.message.navigation.type.SerializablePoint;
        else this.startingPoint = sp; if (ep == null) this.endingPoint = new nfuzion.message.navigation.type.SerializablePoint;
        else this.endingPoint = ep; if (track == null) this.track = new Array;
        else this.track = track;
        this.text = text;
        if (type == null) this.type = nfuzion.message.navigation.type.TransitType.driving;
        else this.type = type
    };
    $hxClasses["nfuzion.message.navigation.type.Step"] = nfuzion.message.navigation.type.Step;
    nfuzion.message.navigation.type.Step.__name__ = ["nfuzion",
        "message", "navigation", "type", "Step"
    ];
    ...
    nfuzion.message.navigation.type.Leg = function(distance, sp, ep, steps) {
        ...
        nfuzion.message.generic.type.TypeClass.call(this);
        this.distance = distance;
        if (sp == null) this.startingPoint = new nfuzion.message.navigation.type.SerializablePoint;
        else this.startingPoint = sp; if (ep == null) this.endingPoint = new nfuzion.message.navigation.type.SerializablePoint;
        else this.endingPoint = ep; if (steps == null) this.steps = new Array;
    ...
    nfuzion.message.navigation.type.Leg.__super__ =
        nfuzion.message.generic.type.TypeClass;
    ...
    $hxClasses["nfuzion.message.navigation.type.Waypoint"] =
        nfuzion.message.navigation.type.Waypoint;
    ...
    nfuzion.message.navigation.type.Route = function(markers, legs, distance) {
        if (distance == null) distance = 0;
        nfuzion.message.generic.type.TypeClass.call(this);
        if (markers == null) this.markers = new Array;
        else this.markers = markers; if (legs == null) this.legs = new Array;
        else this.legs = legs;
        this.distance = distance
    };
    ...
    nfuzion.message.navigation.type.Route.__super__ =
        nfuzion.message.generic.type.TypeClass;
    ...
    nfuzion.message.navigation.SetAddWaypoint.prototype =
        $extend(nfuzion.message.generic.templates.Set.prototype, {
            waypoint: null,
    ...
    nfuzion.message.navigation.SetCancel.prototype =
        $extend(nfuzion.message.generic.templates.Set.prototype, {
    ...
    nfuzion.message.navigation.SetClearRoute.prototype =
        $extend(nfuzion.message.generic.templates.Set.prototype, {
    ...
    nfuzion.message.navigation.SetEndByPoint.__super__ =
        nfuzion.message.generic.templates.Set;
    ...
    nfuzion.message.navigation.SetInsertWaypoint.__name__ =
        ["nfuzion", "message", "navigation", "SetInsertWaypoint"];
    ...
    $hxClasses["nfuzion.message.navigation.SetRemoveWaypoint"] =
        nfuzion.message.navigation.SetRemoveWaypoint;
    ...
    nfuzion.message.navigation.SetStartByPoint.prototype =
        $extend(nfuzion.message.generic.templates.Set.prototype, {
            y: null,
            x: null,
    ...
    nfuzion.message.navigation.SetWaypoints.__super__ =
        nfuzion.message.generic.templates.Set;
    ...
    $hxClasses["nfuzion.message.span.LetClientMetadata"] =
        nfuzion.message.span.LetClientMetadata;
    ...
    nfuzion.message.swc.type.Gesture =
        $hxClasses["nfuzion.message.swc.type.Gesture"] = {
            __ename__: ["nfuzion", "message", "swc", "type", "Gesture"],
            __constructs__: ["oneFingerSwipeLeft", "oneFingerSwipeRight", "oneFingerSwipeUp", "oneFingerSwipeDown", "twoFingerSwipeLeft", "twofingerSwipeRight", "twoFingerSwipeUp", "twoFingerSwipeDown"]
    };
    ...
    nfuzion.message.swc.type.Gesture.oneFingerSwipeDown =
        ["oneFingerSwipeDown", 3];
    ...
    nfuzion.message.swc.type.Gesture.twoFingerSwipeDown.toString =
        $estr;
    nfuzion.message.swc.type.Gesture.twoFingerSwipeDown.__enum__ = nfuzion.message.swc.type.Gesture;
    nfuzion.message.swc.type.Phase = $hxClasses["nfuzion.message.swc.type.Phase"] = {
        __ename__: ["nfuzion", "message", "swc", "type", "Phase"],
        __constructs__: ["start", "change", "end"]
    };
    ...
    nfuzion.message.swc.type.Phase.change.toString =
        $estr;
    ...
    nfuzion.message.test.type.Type.__name__ =
        ["nfuzion", "message", "test", "type", "Type"];
    ...
    nfuzion.message.test.type.Enum = $hxClasses["nfuzion.message.test.type.Enum"] = {
        __ename__: ["nfuzion", "message", "test", "type", "Enum"],
        __constructs__: ["alpha", "bravo", "charlie", "delta"]
    };
    nfuzion.message.test.type.Enum.alpha = ["alpha",
        0
    ];
    ...
    nfuzion.message.test.type.Enum.delta =
        ["delta", 3];
    ...
    nfuzion.message.vehicle.GetABS.__super__ =
        nfuzion.message.generic.templates.Get;
    ...
    nfuzion.message.vehicle.GetBattery.prototype =
        $extend(nfuzion.message.generic.templates.Get.prototype, {
    ...
    nfuzion.message.vehicle.GetDriverDoorOpen.__super__ =
        nfuzion.message.generic.templates.Get;
    ...
    nfuzion.message.vehicle.GetDriverSeated.__super__ =
        nfuzion.message.generic.templates.Get;
    ...
    nfuzion.message.vehicle.GetHighBeam.__super__ =
        nfuzion.message.generic.templates.Get;
    ...
    nfuzion.message.vehicle.GetOil.prototype =
        $extend(nfuzion.message.generic.templates.Get.prototype, {
    ...
    nfuzion.message.vehicle.GetSeatBelt.prototype =
        $extend(nfuzion.message.generic.templates.Get.prototype, {
    ...
    nfuzion.message.vehicle.GetWaterTemperature.prototype =
        $extend(nfuzion.message.generic.templates.Get.prototype, {
    ...
    nfuzion.message.vehicle.LetABS.prototype =
        $extend(nfuzion.message.generic.templates.LetBool.prototype, {
    ...
    nfuzion.message.vehicle.LetAirbag.prototype =
        $extend(nfuzion.message.generic.templates.LetBool.prototype, {
    ...
    nfuzion.message.vehicle.LetBattery.prototype =
        $extend(nfuzion.message.generic.templates.LetBool.prototype, {
    ...
    nfuzion.message.vehicle.LetDriverDoorOpen.__super__ =
        nfuzion.message.generic.templates.LetBool;
    ...
    nfuzion.message.vehicle.LetEmergencyBrake.__name__ =
        ["nfuzion", "message", "vehicle", "LetEmergencyBrake"];
    ...
    nfuzion.message.vehicle.LetFuel.__name__ =
        ["nfuzion", "message", "vehicle", "LetFuel"];
    ...
    nfuzion.message.vehicle.LetGoodbye.__name__ = ["nfuzion",
        "message", "vehicle", "LetGoodbye"
    ];
    ...
    nfuzion.message.vehicle.LetHighBeam.__name__ =
        ["nfuzion", "message", "vehicle", "LetHighBeam"];
    ...
    nfuzion.message.vehicle.LetLocked.__name__ =
        ["nfuzion", "message", "vehicle", "LetLocked"];
    ...
    nfuzion.message.vehicle.LetOdometer.__name__ =
        ["nfuzion", "message", "vehicle", "LetOdometer"];
    ...
    nfuzion.message.vehicle.LetOil.__name__ =
        ["nfuzion", "message", "vehicle", "LetOil"];
    ...
    nfuzion.message.vehicle.LetSeatBelt.__name__ =
        ["nfuzion", "message", "vehicle", "LetSeatBelt"];
    ...
    nfuzion.message.vehicle.LetSpeed.__name__ =
        ["nfuzion", "message", "vehicle", "LetSpeed"];
    ...
    nfuzion.message.vehicle.LetStarted.__name__ =
        ["nfuzion", "message", "vehicle", "LetStarted"];
    ...
    nfuzion.message.vehicle.type.TransmissionState = $hxClasses["nfuzion.message.vehicle.type.TransmissionState"] = {
        __ename__: ["nfuzion", "message", "vehicle", "type", "TransmissionState"],
        __constructs__: ["park", "reverse", "nuetral", "overdrive", "drive", "low2", "low1"]
    };
    ...
    nfuzion.message.vehicle.type.TransmissionState.reverse.toString =
        $estr;
    ...
    nfuzion.message.vehicle.type.TransmissionState.overdrive.toString =
        $estr;
    ...
    nfuzion.message.vehicle.type.TransmissionState.low2.__enum__ =
        nfuzion.message.vehicle.type.TransmissionState;
    ...
    nfuzion.message.vehicle.type.TurnSignalState = $hxClasses["nfuzion.message.vehicle.type.TurnSignalState"] = {
        __ename__: ["nfuzion", "message", "vehicle",
            "type", "TurnSignalState"
        ],
        __constructs__: ["none", "left", "right", "both"]
    };
    ...
    nfuzion.message.vehicle.LetTurnSignal =
        function(state) {
            nfuzion.message.generic.templates.Let.call(this);
            this.state = state
    };
    ...
    nfuzion.message.vehicle.LetWelcome.prototype =
        $extend(nfuzion.message.generic.templates.Let.prototype, {
            subtitle: null,
            title: null,
    ...
    nfuzion.message.vehicle.SetHonk.prototype =
        $extend(nfuzion.message.generic.templates.SetFloat.prototype, {
    ...
    nfuzion.message.vehicle.SetLocked.prototype =
        $extend(nfuzion.message.generic.templates.SetBool.prototype, {
    ...
    $hxClasses["nfuzion.moduleLink.ClientModuleLink"] =
        nfuzion.moduleLink.ClientModuleLink;
    ...
    nfuzion.moduleLink.ClientModuleLink.prototype = $extend(nfuzion.moduleLink.ModuleLink.prototype, {
        onClientMessage: function(e) {
            ...
            if (className.indexOf("Let") == 0) {
                ...
                if (Lambda.has(Type.getInstanceFields(Type.getClass(this)), functionName)) Reflect.field(this,
                    functionName).apply(this, [message]);
                else haxe.Log.trace("Function " + functionName + " not implemented.", {
                    fileName: "ClientModuleLink.hx",
                    lineNumber: 72,
                    className: "nfuzion.moduleLink.ClientModuleLink",
                    methodName: "onClientMessage"
                })
            }
        },
        ...
        onClientConnect: function(e) {
            this.ready = true;
            this.dispatchEvent(new nfuzion.moduleLink.event.ModuleLinkEvent("ready",
                this))
        },
        ...
        __properties__: {
            get_messageTypes: "get_messageTypes"
        }
    });
    ...
    nfuzion.moduleLink.IVehicle.__name__ = ["nfuzion", "moduleLink",
        "IVehicle"
    ];
    ...
    nfuzion.moduleLink.IWindow.__name__ = ["nfuzion", "moduleLink",
        "IWindow"
    ];
    ...
    nfuzion.moduleLink.LeapProxy.prototype = $extend(nfuzion.moduleLink.ClientModuleLink.prototype, {
        ...
        onLetScroll: function(message) {
            this.dispatchEvent(nfuzion.moduleLink.event.LeapEvent.createScrollEvent(message.deltaX,
                message.deltaY, message.velocityX, message.velocityY, message.phase, message.fingerCount))
        },
    ...
    nfuzion.moduleLink.NavigationProxy.prototype = $extend(nfuzion.moduleLink.ClientModuleLink.prototype, {
        ...
        onLetCancel: function(message) {
            haxe.Log.trace("CANCEL!", {
                fileName: "NavigationProxy.hx",
                lineNumber: 115,
                className: "nfuzion.moduleLink.NavigationProxy",
                methodName: "onLetCancel"
            });
    ...
    nfuzion.moduleLink.VehicleProxy.__interfaces__ =
        [nfuzion.moduleLink.IVehicle];
    ...
    nfuzion.moduleLink.event.LeapEvent =
        function(type) {
            nfuzion.event.Event.call(this, type);
            this.x = 0;
            this.y = 0;
    ...
    nfuzion.moduleLink.event.LeapEvent.createScrollEvent = function(deltaX,
        deltaY, velocityX, velocityY, phase, fingerCount) {
        var event = new nfuzion.moduleLink.event.LeapEvent("leapCursor");
        event.deltaX = deltaX;
        event.deltaY = deltaY;
    ...
    nfuzion.moduleLink.event.MagicScrollEvent.__name__ = ["nfuzion",
        "moduleLink", "event", "MagicScrollEvent"
    ];
    ...
    $hxClasses["nfuzion.moduleLink.event.MediaPlayerEvent"] =
        nfuzion.moduleLink.event.MediaPlayerEvent;
    ...
    $hxClasses["nfuzion.moduleLink.event.ModuleLinkEvent"] =
        nfuzion.moduleLink.event.ModuleLinkEvent;
    ...
    $hxClasses["nfuzion.moduleLink.event.NavigationEvent"] =
        nfuzion.moduleLink.event.NavigationEvent;
    ...
    $hxClasses["nfuzion.moduleLink.event.VehicleEvent"] =
        nfuzion.moduleLink.event.VehicleEvent;
    ...
    nfuzion.nTactic.core.AppModel = function() {
        ...
        while ($it0.hasNext()) {
            ...
            screenModel.addEventListener("branchLoaded",
                $bind(this, this.propagateEvent))
        }
    };
    ...
    nfuzion.nTactic.core.AppModel.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        ...
        "goto": function(branch, vars, addToHistory) {
            if (addToHistory == null) addToHistory = true;
            haxe.Log.trace("NOTICE: Loading: " + branch, {
                fileName: "AppModel.hx",
                lineNumber: 158,
                className: "nfuzion.nTactic.core.AppModel",
                methodName: "goto"
            });
            ...
            if (addressArray.length > 1) {
                ...
                if (model != null) model["goto"](addressArray[1], vars, addToHistory);
                else haxe.Log.trace("ERROR: Could not find screen model: " +
                    addressArray[0], {
                        fileName: "AppModel.hx",
                        lineNumber: 173,
                        className: "nfuzion.nTactic.core.AppModel",
        ...
        loadInitialScreens: function() {
            ...
            while (_g < _g1.length) {
                ...
                if (model.initialBranch != null && model.initialBranch != "") {
                    ...
                    if (!model.initialBranchLoaded) model.addEventListener("branchLoaded", $bind(this, this.onInitialBranchLoaded));
                    else this.onInitialBranchLoaded()
                }
            }
        },
        loadScreenModelBranch: function(screenModelId, branch, vars) {
            var _g1 = 0,
                _g = this.screenModels.length;
            while (_g1 < _g) {
                var i = _g1++;
        ...
        getInitialBranch: function(screenModelId) {
            try {
                ...
                if (js.Boot.__instanceof(message,
                    String));
                else throw message;
            }
            return ""
    ...
    nfuzion.nTactic.core.AppView.prototype = {
        getLayer: function(depth) {
            ...
            if (layer == null) {
                var index = -1;
                var _g1 = 0,
                    _g = nfuzion.nTactic.NTactic.stage.get_childCount();
                while (_g1 < _g) {
                    var i = _g1++;
                ...
                nfuzion.nTactic.NTactic.stage.insertChild(layer,
                    index)
            }
            return layer
        },
    ...
    nfuzion.nTactic.core.BranchHistory.__name__ = ["nfuzion", "nTactic",
        "core", "BranchHistory"
    ];
    ...
    nfuzion.nTactic.core.CacheManager.prototype = {
        ...
        release: function(id) {
            if (!this.cacheAll && !(nfuzion.nTactic.NTactic.cache.getRecord(id).priority ==
                134217727)) nfuzion.nTactic.NTactic.cache.destroy(id)
        },
        "use": function(id) {},
    ...
    nfuzion.nTactic.core.Screen.prototype = $extend(nfuzion.graphics.Container.prototype, {
        removeSubScreen: function(subScreen) {
            HxOverrides.remove(this.subScreens,
                subScreen);
            if (!this.entered) {
        ...
        onReady: function() {
            haxe.Log.trace(" ** *  *   *     *  Screen " + this.graphicsClassName + " is ready!  *    *   *  * ** ", {
                fileName: "Screen.hx",
                lineNumber: 402,
                className: "nfuzion.nTactic.core.Screen",
                methodName: "onReady"
            });
            this.initalGraphicsLoaded = true;
            this.dispatchEvent(new nfuzion.nTactic.event.ScreenEvent("ready",
                this))
        },
        ...
        detatchImage: function(url) {
            if (url != null && url != "")
                if (this.imageRecords.exists(url)) {
                    ...
                    if (references > 1) this.imageRecords.set(url, this.imageRecords.get(url) - 1);
                ...
                } else haxe.Log.trace("WARNING: cannot detatch image " + url, {
                    fileName: "Screen.hx",
                    lineNumber: 355,
                    className: "nfuzion.nTactic.core.Screen",
                    methodName: "detatchImage"
                })
        },
        attachImage: function(url, wait) {
            ...
            if (url != null && url != "")
                if (this.imageRecords.exists(url)) {
                    this.imageRecords.set(url,
                        this.imageRecords.get(url) + 1);
        ...
        setComponentImage: function(component, url, fit, timeout) {
            if (url != "" && url != null) {
                if (!this.imageLoaders.exists(url + component.name)) {
                    var loader = new nfuzion.image.ImageLoader(url,
                        component, fit, timeout);
                    if (!loader.complete) {
        ...
        detachListener: function(dispatcher,
            type, listener) {
        ...
        initializeScreen: function() {
            if (this.useBuilder)
                if (!nfuzion.nTactic.NTactic.builder.buildOver(this.graphicsClassName, this)) haxe.Log.trace("ERROR: Screen graphics class not found for " + this.graphicsClassName + ".  A ghost screen will be created.", {
                    fileName: "Screen.hx",
                    lineNumber: 104,
                    className: "nfuzion.nTactic.core.Screen",
                    methodName: "initializeScreen"
                });
            this.group = new nfuzion.widget.Group(this.graphicsClassName,
                this)
        },
        destroy: function() {
            this.group.destroy();
        ...
        __properties__: $extend(nfuzion.graphics.Container.prototype.__properties__, {
            set_modelData: "set_modelData",
            get_modelData: "get_modelData"
        })
    });
    ...
    $hxClasses["nfuzion.nTactic.core.DynamicScreen"] =
        nfuzion.nTactic.core.DynamicScreen;
    ...
    nfuzion.nTactic.core.Layer.__name__ =
        ["nfuzion", "nTactic", "core", "Layer"];
    ...
    nfuzion.nTactic.core.ScreenCache.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        ...
        destroy: function(branch) {
            ...
            haxe.Log.trace("NOTE: Could not destroy screen " + branch, {
                fileName: "ScreenCache.hx",
                lineNumber: 102,
                className: "nfuzion.nTactic.core.ScreenCache",
                methodName: "destroy"
            });
            return false
        },
        release: function(branch) {
            if (this.screenRecords.exists(branch)) {
                haxe.Log.trace(" [ - ] Releasing screen: " + branch, {
                    fileName: "ScreenCache.hx",
                    lineNumber: 87,
                    className: "nfuzion.nTactic.core.ScreenCache",
                    methodName: "release"
        ...
        createScreen: function(screenRecord, model) {
            ...
            if (cls == null) {
                haxe.Log.trace("FATAL: Could not instantiate '" + className + "'.  Check the screen name and verify that it is imported.", {
                    fileName: "ScreenCache.hx",
                    lineNumber: 69,
                    className: "nfuzion.nTactic.core.ScreenCache",
        ...
        get: function(record) {
            if (record.screen == null) {
                haxe.Log.trace(" [ + ] Creating Screen: " + record.branch, {
                    fileName: "ScreenCache.hx",
                    lineNumber: 36,
                    className: "nfuzion.nTactic.core.ScreenCache",
                    methodName: "get"
            ...
            } else haxe.Log.trace(" [ = ] Reusing screen: " +
                record.branch, {
                    fileName: "ScreenCache.hx",
                    lineNumber: 41,
                    className: "nfuzion.nTactic.core.ScreenCache",
    ...
    nfuzion.nTactic.core.ScreenModel.__super__ =
        nfuzion.event.EventDispatcher;
    nfuzion.nTactic.core.ScreenModel.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        ...
        updateHistory: function(branch, ext) {
            ...
            if (this.mMaxHistoryLength > 0) {
                if (branch != "" && branch != this.currentBranch) this.mBackHistory.push(new nfuzion.nTactic.core.BranchHistory(this.currentBranch, this.modelData));
                else if (ext) this.mBackHistory.push(new nfuzion.nTactic.core.BranchHistory(this.currentBranch,
                    this.modelData));
        ...
        removeScreens: function() {
            ...
            while (this.mScreensToRemove.length > 0) {
                ...
                if (screen != null) {
                    screen.removeEventListener("ready", $bind(this,
                        this.onScreenReady));
        ...
        getScreenRecord: function(branch) {
            var record =
                nfuzion.nTactic.NTactic.cache.getRecord(this.id + ":" + branch);
            if (record == null) haxe.Log.trace("WARNING: Could not locate screen branch: " + this.id + ":" + branch, {
                fileName: "ScreenModel.hx",
                lineNumber: 383,
                className: "nfuzion.nTactic.core.ScreenModel",
                methodName: "getScreenRecord"
            });
            return record
        },
        ...
        setScreensToAddOrRemove: function(oldBranch, newBranch) {
            ...
            if (this.oldBranchRecords.length > 0) {
                ...
                while (--i > -1)
                    if (this.newBranchRecords.length <= i || this.newBranchRecords[i] != this.oldBranchRecords[i]) this.mScreensToRemove.push(this.oldBranchRecords[i]);
                    else
                if (this.newBranchRecords[i] == this.oldBranchRecords[i]) break
            }
            if (this.newBranchRecords.length > 0) {
                i = this.newBranchRecords.length;
                while (--i > -1)
                    if (this.oldBranchRecords.length <= i || this.newBranchRecords[i] != this.oldBranchRecords[i]) this.mScreensToAdd.push(this.newBranchRecords[i]);
                    else
                if (this.newBranchRecords[i] == this.oldBranchRecords[i]) break
            }
        },
        releaseScreens: function(screens) {
            if (screens == null);
                ...
                while (_g < screens.length) {
                    ...
                    ++_g;
                    var record = nfuzion.nTactic.NTactic.cache.getRecord(this.id +
                        ":" + screenBranch);
                    if (record != null) {
                        haxe.Log.trace("NOTE: Setting priority for " + record.branch + " to MIN", {
                            fileName: "ScreenModel.hx",
                            lineNumber: 281,
                            className: "nfuzion.nTactic.core.ScreenModel",
                            methodName: "releaseScreens"
                    ...
                    } else haxe.Log.trace("WARNING: could not find record for branch: " + screenBranch + " Screen will not be released", {
                        fileName: "ScreenModel.hx",
                        lineNumber: 293,
                        className: "nfuzion.nTactic.core.ScreenModel",
                        methodName: "releaseScreens"
        ...
        cacheScreens: function(screens) {
            if (screens == null);
                ...
                while (_g < screens.length) {
                    ...
                    if (record != null) {
                        haxe.Log.trace("Setting priority for " + record.branch + " to MAX", {
                            fileName: "ScreenModel.hx",
                            lineNumber: 243,
                            className: "nfuzion.nTactic.core.ScreenModel",
                            methodName: "cacheScreens"
                        ...
                        if (record.screen == null) {
                            haxe.Log.trace("NOTE: Preloading " +
                                record.branch + ".", {
                                    fileName: "ScreenModel.hx",
                                    lineNumber: 248,
                                    className: "nfuzion.nTactic.core.ScreenModel",
                        ...
                        } else haxe.Log.trace("WARNING: could not find record for branch: " + screenBranch + " Screen will not be cached", {
                            fileName: "ScreenModel.hx",
                            lineNumber: 256,
                            className: "nfuzion.nTactic.core.ScreenModel",
                            methodName: "cacheScreens"
        ...
        "goto": function(branch, modelData, addToHistory) {
            ...
            if (this.mScreensToAdd.length >
                0) this.addScreens();
            else this.updateModelData();
            this.branchReady();
        ...
        addScreenRecord: function(screenXml, parentScreens) {
            ...
            if (screenXml.exists("priority")) {
                ...
                if (priority == "max") screenRecord.priority = 134217727;
                else if (priority == "min") screenRecord.priority = 134217728;
                else screenRecord.priority = Std.parseInt(priority)
        ...
        initialize: function(xml) {
            ...
            if (xml.exists("initialBranch")) this.initialBranch = xml.get("initialBranch");
            else this.initialBranch = "";
        ...
        destroyScreen: function() {
            ...
            if (this.screen != null)
                if (!this.inUse && !this.screen.entered) {
                    haxe.Log.trace(" [ X ] Destroying screen: " +
                        this.branch, {
                            fileName: "ScreenRecord.hx",
                            lineNumber: 34,
                            className: "nfuzion.nTactic.core.ScreenRecord",
                            methodName: "destroyScreen"
                        });
                    this.screen.destroy();
                    this.screen = null;
                    success = true
    ...
    nfuzion.nTactic.core.SubScreen = function(parentGroup, fillParent, graphicsClassName) {
        ...
        nfuzion.nTactic.core.Screen.call(this,
            graphicsClassName, fillParent);
    ...
    nfuzion.nTactic.event.ScreenModelEvent.prototype =
        $extend(nfuzion.event.Event.prototype, {
            modelData: null,
            branch: null,
            modelId: null,
    ...
    nfuzion.paint.PaintManager.__name__ = ["nfuzion",
        "paint", "PaintManager"
    ];
    ...
    nfuzion.physics.IPhysics.__name__ =
        ["nfuzion", "physics", "IPhysics"];
    ...
    nfuzion.physics.Scrolling.__interfaces__ =
        [nfuzion.physics.IPhysics];
    ...
    nfuzion.physics.Scrolling.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        ...
        getTouchDelta: function(delta) {
            if (this.orientation == nfuzion.type.Orientation.horizontal) return delta.x;
            else return delta.y
        },
        onPaint: function(e) {
            ...
            if (this.gliding) {
                ...
                if (Math.abs(this.velocity) < this.snapThreshold && Math.abs(visualExcess) <= 1) this.onSnapThreshold();
                else {
                    var newVelocity;
                    var positionDelta = 0;
                    if (this.velocity >
                        ...
                        else positionDelta = this.velocity * frameTime + 250 * Math.pow(frameTime, 2)
                    } else {
                        newVelocity = this.velocity + 500 * frameTime;
                        if (newVelocity > 0) newVelocity = 0;
                        else positionDelta = this.velocity * frameTime - 250 * Math.pow(frameTime, 2)
            ...
            if (newPosition != this.rawPosition)
                if (newPosition > 0 && this.rawPosition <= 0 || (this.length <= 0 && (newPosition <
                    0 && this.rawPosition >= 0) || newPosition < this.length && this.rawPosition >= this.length)) {
        ...
        repaint: function(e) {
            if (nfuzion.nTactic.NTactic.stage !=
                null && !this.repaintRequested) {
        ...
        destroy: function() {
            nfuzion.nTactic.NTactic.stage.removeEventListener("move",
        ...
        set_scroller: function(scroller) {
            if (this.scroller != null) {
                this.scroller.removeEventListener("ScrollerEvent.grab", $bind(this, this.onScrollerGrab));
                this.scroller.removeEventListener("ScrollerEvent.position",
                    $bind(this, this.onScrollerPosition));
                this.scroller.removeEventListener("ScrollerEvent.release", $bind(this, this.onScrollerRelease))
            }
            ...
            if (scroller != null) {
                ...
                scroller.addEventListener("ScrollerEvent.position", $bind(this,
                    this.onScrollerPosition));
        ...
        set_position: function(position) {
            if (position < 0 || this.length <= 0) this.set_rawPosition(position / 0.2);
            else if (position > this.length) this.set_rawPosition(this.length + (position - this.length) / 0.2);
            else this.set_rawPosition(position);
            this.repaint();
            return position
        },
        get_position: function() {
            if (this.rawPosition < 0 || this.length <= 0) return this.rawPosition * 0.2;
            else if (this.rawPosition >
                this.length) return this.length + (this.rawPosition - this.length) * 0.2;
        ...
        set_step: function(step) {
            ...
            if (this.scroller != null) {
                ...
                this.scroller.set_maximum((this.length +
                    step - this.bottomPadding) / this.rowSize)
            }
            return step
        },
        step: null,
        ...
        __properties__: {
            ...
            set_step: "set_step",
            set_rawPosition: "set_rawPosition",
            get_boundedPosition: "get_boundedPosition",
            set_position: "set_position",
            get_position: "get_position",
            set_scroller: "set_scroller",
            set_touchTarget: "set_touchTarget"
        }
    });
    ...
    nfuzion.sketch.XmlSketch = function(path) {
        ...
        path = nfuzion.nTactic.NTactic.assetsPath +
            path;
        ...
        if (lasIndex > 0) this.themePath = HxOverrides.substr(this.mBluePrintPath, 0, lasIndex + 1);
        else this.themePath = "";
        this.loader.request()
    };
    $hxClasses["nfuzion.sketch.XmlSketch"] = nfuzion.sketch.XmlSketch;
    nfuzion.sketch.XmlSketch.__name__ = ["nfuzion", "sketch", "XmlSketch"];
    nfuzion.sketch.XmlSketch.__interfaces__ =
        [nfuzion.sketch.ISketch];
    ...
    nfuzion.sketch.XmlSketch.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        ...
        getRelativePath: function(path) {
            var out = path;
            if (StringTools.startsWith(path, "./")) out = this.themePath + HxOverrides.substr(path,
                2, null);
            return out
        },
        readContainer: function(element, isGuise) {
            ...
            var sketchContainer;
            if (!isGuise) sketchContainer = new nfuzion.sketch.type.SketchContainer(element.get("name"), Std.parseInt(element.get("x")), Std.parseInt(element.get("y")), 0, 0);
            else sketchContainer = new nfuzion.sketch.type.SketchContainer(element.get("name"), 0, 0, 0, 0);
            var className = element.get("class");
            if (className != null) sketchContainer.className = className;
            else {
                if (!isGuise) sketchContainer.setSize(Std.parseInt(element.get("width")),
                    Std.parseInt(element.get("height")));
            ...
            while ($it0.hasNext()) {
                ...
                switch (_g) {
                    ...
                    case "Text":
                        ...
                        if (element.get("wrap") != null) sketchText.wrap = element.get("wrap") ==
                            "true";
                    ...
                    case "Frame":
                        ...
                        if (fitString !=
                            null) fit = Type.createEnum(nfuzion.graphics.type.Fit, fitString);
                    ...
                    case "Mask":
                        var fit = null;
                        var fitString = element.get("fit");
                        if (fitString != null) fit = Type.createEnum(nfuzion.graphics.type.Fit,
                            fitString);
                        if (fit == null) fit = nfuzion.graphics.type.Fit.stretch;
        ...
        parseClasses: function() {
            ...
            while ($it0.hasNext()) {
                ...
                var buildClass = new nfuzion.sketch.type.SketchContainer(name, 0, 0, Std.parseInt(classXml.get("width")),
                    Std.parseInt(classXml.get("height")));
        ...
        onReady: function(e) {
            ...
            if (this.loader.data != null) {
                try {
                    ...
                    haxe.Log.trace("ERROR: " + Std.string(e1), {
                        fileName: "XmlSketch.hx",
                        lineNumber: 80,
                        className: "nfuzion.sketch.XmlSketch",
                        methodName: "onReady"
                    });
                    this.assets = null
                }
                if (this.assets == null) {
                    haxe.Log.trace("ERROR: No 'Assets' ag found.", {
                        fileName: "XmlSketch.hx",
                        lineNumber: 85,
                        className: "nfuzion.sketch.XmlSketch",
                        methodName: "onReady"
            ...
            if (this.assets ==
                null) haxe.Log.trace("ERROR: No assets loaded.", {
                fileName: "XmlSketch.hx",
                lineNumber: 94,
                className: "nfuzion.sketch.XmlSketch",
                methodName: "onReady"
    ...
    nfuzion.sketch.type.SketchComponent.prototype =
        $extend(nfuzion.geometry.Box.prototype, {
    ...
    nfuzion.sketch.type.SketchContainer = function(name,
        x, y, width, height) {
        if (height == null) height = 0;
        if (width == null) width = 0;
        if (y == null) y = 0;
    ...
    nfuzion.span.ISpanClient.__name__ =
        ["nfuzion", "span", "ISpanClient"];
    ...
    nfuzion.span.SpanClient.parseUrlString = function(urlString, throwHints) {
        ...
        switch (url.protocol) {
            ...
            case "ghost":
                break;
            default:
                if (throwHints) throw "The protocol '" +
        ...
        switch (url.protocol) {
            ...
            case "ghost":
                ...
                break;
            default:
                haxe.Log.trace("ERROR: This should never happen: protocol = " + url.protocol, {
                    fileName: "SpanClient.hx",
                    lineNumber: 101,
                    className: "nfuzion.span.SpanClient",
                    methodName: "parseUrlString"
                });
                return null
        }
        return url
    ...
    nfuzion.span.SpanClient.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        ...
        onClientDisconnect: function(e) {
            ...
            if (this.autoConnect)
                if (this.reconnectDelay == null) this.reconnectDelay = new nfuzion.timer.Delay($bind(this,
                    this.reconnect), 1)
        },
        onClientConnect: function(e) {
        ...
        newClient: function(urlString, lingo) {
            ...
            switch (_g.url.protocol) {
                case "ws":
                    this.client =
                        new nfuzion.client.WebSocketClient(this.url.host, this.url.port);
                    break;
                case "ghost":
                    this.client = new nfuzion.client.GhostClient;
                    break;
                default:
                    haxe.Log.trace("ERROR: This should never happen: protocol = " + this.url.protocol, {
                        fileName: "SpanClient.hx",
                        lineNumber: 131,
                        className: "nfuzion.span.SpanClient",
            ...
            if (lingo == null) {
                ...
                switch (_g1.url.port) {
                    ...
                    case 4413:
                        ...
                        break;
                    default:
                        haxe.Log.trace("WARNING: No default lingo specified for port " + this.url.port + ".  Using XmlLingo.", {
                            fileName: "SpanClient.hx",
                            lineNumber: 145,
                            className: "nfuzion.span.SpanClient",
                            methodName: "newClient"
    ...
    nfuzion.span.event.SpanClientEvent.__name__ =
        ["nfuzion", "span", "event", "SpanClientEvent"];
    ...
    nfuzion.storage.PersistentStorage = function() {
        ...
        this.ready = false;
        nfuzion.storage.PersistentStorage.instance =
            this;
    ...
    nfuzion.storage.PersistentStorage.__super__ =
        nfuzion.event.EventDispatcher;
        ...
        loadLocalStorage: function() {
            ...
            while (_g < localStorageKeys.length) {
                ...
                try {
                    ...
                    record.addEventListener("RecordEvent.change", $bind(this,
                        this.onRecordChange))
                } catch (e) {}
            }
            this.ready = true;
    ...
    nfuzion.storage.Record.__super__ =
        nfuzion.event.EventDispatcher;
    ...
    nfuzion.storage.event.RecordEvent =
    ...
    nfuzion.timer.Delay = function(callbackFunction, delay) {
        ...
        this.delayTimer = haxe.Timer.delay(callbackFunction,
    ...
    nfuzion.timer.Delay.now = function() {
        ...
        if (timestamp < nfuzion.timer.Delay.lastTimestamp) {
            haxe.Log.trace("FATAL: Timer is broken!", {
                fileName: "Delay.hx",
                lineNumber: 43,
                className: "nfuzion.timer.Delay",
                methodName: "now"
            });
            return -3.4E38
        }
    ...
    nfuzion.timer.Timer.prototype = $extend(nfuzion.event.EventDispatcher.prototype, {
        ...
        start: function() {
            ...
            this.timer = new haxe.Timer(Math.round(this.period * 1E3));
    ...
    nfuzion.tween.type = {};
    nfuzion.tween.type.TweenProperty = function(target,
        name, targetValue, type) {
        this.target = target;
        this.name = name;
        ...
        if (success) this.get = $bind(this, this.getProperty);
        else try {
        ...
        if (this.get == null) {
            haxe.Log.trace("ERROR: Getter for property '" + name + "' could not be found.", {
                fileName: "TweenProperty.hx",
                lineNumber: 62,
                className: "nfuzion.tween.type.TweenProperty",
                methodName: "new"
            });
            return
        }
        ...
        if (success) this.set = $bind(this, this.setProperty);
        else try {
        ...
        if (this.set == null) {
            haxe.Log.trace("ERROR: Setter for property '" + name + "' could not be found.", {
                fileName: "TweenProperty.hx",
                lineNumber: 93,
                className: "nfuzion.tween.type.TweenProperty",
                methodName: "new"
    ...
    nfuzion.tween.type.TweenType = $hxClasses["nfuzion.tween.type.TweenType"] = {
        __ename__: ["nfuzion", "tween", "type", "TweenType"],
        __constructs__: ["linear", "fast", "slow"]
    };
    ...
    nfuzion.type = {};
    nfuzion.type.Alignment = $hxClasses["nfuzion.type.Alignment"] = {
        __ename__: ["nfuzion", "type", "Alignment"],
    ...
    nfuzion.type.Color = $hxClasses["nfuzion.type.Color"] = {
        __ename__: ["nfuzion", "type",
            "Color"
        ],
        __constructs__: ["aqua", "black", "blue", "fuchsia", "gray", "green", "red", "white", "yellow", "rgb"]
    };
    ...
    nfuzion.type.Color.rgb = function(red, green, blue) {
        var $x = ["rgb", 9, red, green, blue];
        $x.__enum__ = nfuzion.type.Color;
        $x.toString = $estr;
        return $x
    };
    ...
    nfuzion.type.Orientation = $hxClasses["nfuzion.type.Orientation"] = {
        __ename__: ["nfuzion", "type", "Orientation"],
    ...
    nfuzion.type.VerticalAlignment = $hxClasses["nfuzion.type.VerticalAlignment"] = {
        __ename__: ["nfuzion", "type", "VerticalAlignment"],
        __constructs__: ["top", "middle", "bottom"]
    };
    ...
    nfuzion.type.VerticalAlignment.bottom.__enum__ =
        nfuzion.type.VerticalAlignment;
    nfuzion.url = {};
            ...
            if (urlString != null) {
                ...
                if (urlArray.length == 2) {
                    ...
                    if (index >= 0)
                        if (index == 0) {
                            ...
                            urlString = HxOverrides.substr(urlString,
                                0, index);
                ...
                while (_g1 < _g) {
                    ...
                    if (!(charCode >= HxOverrides.cca("a", 0) && charCode <= HxOverrides.cca("z", 0) || (charCode >= HxOverrides.cca("A", 0) && charCode <= HxOverrides.cca("Z", 0) || (charCode >= HxOverrides.cca("0", 0) && charCode <= HxOverrides.cca("9", 0) || (charCode == HxOverrides.cca("-", 0) || charCode == HxOverrides.cca(".", 0)))))) {
                        if (throwHints) throw "The hostname may not contain the character '" +
                            this.host.charAt(i) + "'.";
                        return
                    }
                }
    ...
    nfuzion.utility.BaseCode32.encodeString =
        function(string) {
    ...
    nfuzion.utility.CharacterTools =
        function() {};
    ...
    nfuzion.utility.ColorTools.fromString = function(value) {
        ...
        if (nfuzion.utility.CharacterTools.isAlpha(HxOverrides.cca(value, 0))) try {
            color = Type.createEnum(nfuzion.type.Color,
                value)
        } catch (e) {
            color = null
        } else {
    ...
    nfuzion.widget.Simple.__name__ =
        ["nfuzion", "widget", "Simple"];
    ...
    nfuzion.widget.Simple.prototype = $extend(nfuzion.event.ListenerManagerAndEventDispatcher.prototype, {
        ...
        set_enabled: function(enabled) {
            if (this.target != null) {
                if (this.target.touchEnabled != enabled) {
                    ...
                    if (enabled) this.restoreListeners();
                    else {
                        this.removeListeners();
                        this.cancel()
                    }
        ...
        set_visible: function(visible) {
            ...
            if (this.implementation != null) {
                var change = this.implementation.visible !=
                    visible;
                if (change) {
        ...
        findComponents: function(container) {
            ...
            if (this.hotspot != null) this.set_target(this.hotspot);
            else this.set_target(this.implementation);
        ...
        encloseGraphics: function(component) {
            if (this.implementation !=
                null) {
                haxe.Log.trace("ERROR: Widget already contains graphics.", {
                    fileName: "Simple.hx",
                    lineNumber: 78,
                    className: "nfuzion.widget.Simple",
                    methodName: "encloseGraphics"
                });
                return false
            }
        ...
        __properties__: {
            ...
            set_acceptsFocus: "set_acceptsFocus",
            get_acceptsFocus: "get_acceptsFocus",
            get_hasFocus: "get_hasFocus",
            get_hasHotspot: "get_hasHotspot",
            get_fullName: "get_fullName"
        }
    });
    ...
    nfuzion.widget.Group.prototype = $extend(nfuzion.widget.Simple.prototype, {
        ...
        get_fullName: function() {
            ...
            return this.parent.get_fullName() +
                "." + this.name
        },
        copy: function(from) {
        ...
        findChildWidgets: function(container) {
            ...
            while (_g < _g1.length) {
                ...
                if (!done)
                    if (js.Boot.__instanceof(child,
                        nfuzion.graphics.Container)) this.findChildWidgets(child)
            }
        },
        ...
        findComponents: function(container) {
            nfuzion.widget.Simple.prototype.findComponents.call(this,
                container);
        ...
        insertChild: function(child, index) {
            if (index == null) index = 0;
            if (this.get_childCount() ==
                0 || index >= this.get_childCount()) return this.appendChild(child);
            if (index <= 0) index = 0;
        ...
        appendChild: function(child) {
            if (child ==
                null) throw "ERROR: Failed to add null child on " + this.name + ".";
            if (this.implementation != null && js.Boot.__instanceof(this.implementation, nfuzion.graphics.Container)) {
                var container = this.implementation;
        ...
        onButtonClick: function(e) {
            if (!e.target.activated) this.setSelection(e.target.name);
            else if (!this.requireSelection) this.setSelection(null);
            else this.setSelection(e.target.name)
        },
        ...
        setSelection: function(selection, doEventDispatch) {
            ...
            while (_g < _g1.length) {
                ...
                if (widget != null && StringTools.endsWith(widget.name, "_button")) {
                    ...
                    if (found || widget.name != selection) button.set_activated(false);
                    else {
                        found = true;
                        if (button.activated) {
            ...
            while (_g < _g1.length) {
                ...
                if (widget != null && StringTools.endsWith(widget.name, "_button"))
                    if (radioButtons) {
                        ...
                        if (found) button.set_activated(false);
                        else if (button.activated) found = true
        ...
        set_exclusiveChildren: function(exclusiveChildren) {
            ...
            if (exclusiveChildren) this.attachListener(this, "WidgetEvent.visibility", $bind(this, this.onVisibility));
            else this.detachListener(this, "WidgetEvent.visibility", $bind(this, this.onVisibility)); if (exclusiveChildren) this.onVisibility();
        ...
        getWidgetByArray: function(nameArray) {
            ...
            if (child ==
                null) {
                haxe.Log.trace("ERROR: Could not find or create child '" + name + "'.", {
                    fileName: "Group.hx",
                    lineNumber: 72,
                    className: "nfuzion.widget.Group",
                    methodName: "getWidgetByArray"
                });
                return null
            }
            if (nameArray.length > 0) {
                var group = child;
                if (group != null) return group.getWidgetByArray(nameArray);
                else {
                    haxe.Log.trace("ERROR: Widget '" + name + "' cannot contain children.", {
                        fileName: "Group.hx",
                        lineNumber: 84,
                        className: "nfuzion.widget.Group",
                        methodName: "getWidgetByArray"
        ...
        __properties__: $extend(nfuzion.widget.Simple.prototype.__properties__, {
            set_exclusiveChildren: "set_exclusiveChildren",
            set_radioButtons: "set_radioButtons",
            set_requireSelection: "set_requireSelection",
            set_eventsRequireChange: "set_eventsRequireChange",
            get_childCount: "get_childCount"
        })
    });
    ...
    nfuzion.widget.Button.prototype = $extend(nfuzion.widget.Group.prototype, {
        ...
        updateIcons: function() {
            if (this.iconFrameName != null)
                if (this.icon != null) {
                    ...
                    if (this.icon.frames.exists(frameName)) this.icon["goto"](frameName);
                    else this.icon["goto"](this.iconFrameName)
                }
        },
        ...
        set_pressed: function(pressed) {
            ...
            if (pressed) this.dispatchEvent(new nfuzion.widget.event.ButtonEvent("ButtonEvent.down", this, true));
            else if (this.currentTouchId ==
                null) this.dispatchEvent(new nfuzion.widget.event.ButtonEvent("ButtonEvent.up", this, true));
            else this.dispatchEvent(new nfuzion.widget.event.ButtonEvent("ButtonEvent.up", this, true));
            return pressed
        },
        pressed: null,
        toggle: function() {
        ...
        update: function() {
            ...
            } if (this.implementation.frames.exists(this.iconFrameNameSuffix)) this.implementation["goto"](this.iconFrameNameSuffix);
            else if (this.implementation.frames.keys().hasNext()) this.implementation["goto"](this.implementation.frames.keys().next());
            this.updateIcons()
        },
        set_requireDirectTouch: function(requireDirectTouch) {
            if (this.requireDirectTouch !=
                requireDirectTouch) this.requireDirectTouch = requireDirectTouch;
        ...
        onDownLong: function(e) {
            ...
            this.mDirectClick = false;
            this.dispatchEvent(new nfuzion.widget.event.ButtonEvent("ButtonEvent.longPress",
                this, true))
        },
        release: function() {
            if (this.pressed) {
        ...
        startTouch: function() {
            this.attachListener(this.target.get_stage(),
                "end", $bind(this, this.onTouchEnd));
            this.attachListener(this.target, "out", $bind(this, this.onTouchOut));
            if (this.pressDelayPeriod > 0) this.pressDelay = new nfuzion.timer.Delay($bind(this, this.press), this.pressDelayPeriod);
            else this.press()
        },
        onTouchEnd: function(e) {
            if (this.currentTouchId == e.id) {
                ...
                if (e.target == this.target) {
                    ...
                    e.stopPropagation();
                    this.dispatchEvent(new nfuzion.widget.event.ButtonEvent("ButtonEvent.click",
                        this, true))
                }
                this.release()
            }
        ...
        onTouchOver: function(e) {
            ...
            if (!this.requireDirectTouch && this.currentTouchId == null) {
        ...
        addListeners: function() {
            ...
            this.attachListener(this.longPressTimer,
                "timer", $bind(this, this.onDownLong));
        ...
        findComponents: function(container) {
            ...
            this.icon = this.getComponentChild(this.implementation,
                "icon");
        ...
        __properties__: $extend(nfuzion.widget.Group.prototype.__properties__, {
            set_longPressDelay: "set_longPressDelay",
            get_longPressDelay: "get_longPressDelay",
            set_toggleMode: "set_toggleMode",
            set_autoRepeatPeriod: "set_autoRepeatPeriod",
            set_autoRepeatDelay: "set_autoRepeatDelay",
            set_requireDirectTouch: "set_requireDirectTouch",
    ...
    nfuzion.widget.Chain.prototype = $extend(nfuzion.widget.Group.prototype, {
        onScrollerPosition: function(e) {
            if (this.pageScroller.thumbDown) {
                this.currentPage =
                    Math.round(this.pageScroller.get_value());
                this.gotoPage()
            }
        },
        onMagicScroll: function(e) {
        ...
        copy: function(from) {
            nfuzion.widget.Group.prototype.copy.call(this,
                from);
        ...
        gotoPage: function() {
            ...
            this.snapTweenB = new nfuzion.tween.Tween(0.2, [new nfuzion.tween.type.TweenProperty(this.pageB.implementation, "x", -this.currentPage * pageWidth + pageWidth + this.pageOffset, nfuzion.tween.type.TweenType.fast), new nfuzion.tween.type.TweenProperty(this.pageB.implementation,
                "alpha", this.currentPage == 0 ? 0 : 1)]);
            this.updatePageIndicator();
            this.updateDirectionalButtons()
        },
        snap: function() {
            if (this.pageA == null) return;
            if (this.pageA.implementation._x < -this.pageA.implementation._width / 2) this.currentPage = 1;
            else this.currentPage = 0; if (Math.abs(this.velocity) > 2)
                if (this.velocity > 0) this.currentPage = 0;
        ...
        nextPage: function(e) {
            this.currentPage++;
            if (this.currentPage >=
                this.pageCount) this.currentPage = this.pageCount - 1;
            this.gotoPage()
        },
        ...
        updateDirectionalButtons: function() {
            if (this.pageCount > 1) {
                if (this.previousButton != null) {
                    ...
                    if (this.currentPage == 0) this.previousButton.set_enabled(false);
                    else this.previousButton.set_enabled(true)
                }
                if (this.nextButton !=
                    null) {
                    this.nextButton.set_visible(true);
                    if (this.currentPage == this.pageCount - 1) this.nextButton.set_enabled(false);
                    else this.nextButton.set_enabled(true)
                }
            } else {
        ...
        addListeners: function() {
            ...
            if (this.pageScroller !=
                null) this.attachListener(this.pageScroller, "ScrollerEvent.position", $bind(this, this.onScrollerPosition))
        },
        updatePageIndicatorItem: function(itemWidget) {
            var widget = itemWidget.widget;
            var data = itemWidget.data;
            if (data) widget.implementation["goto"]("active");
            else widget.implementation["goto"]("inactive")
        },
        set_pageCount: function(pageCount) {
            this.pageCount = pageCount;
            if (pageCount > 1) this.pagingEnabled = true;
            else this.pagingEnabled = false; if (this.pageScroller != null) this.pageScroller.set_maximum(pageCount - 1);
        ...
        nextButton: null,
        findComponents: function(container) {
            nfuzion.widget.Group.prototype.findComponents.call(this,
                container);
            this.set_enabled(true);
        ...
        __properties__: $extend(nfuzion.widget.Group.prototype.__properties__, {
            ...
            set_pageCount: "set_pageCount",
            set_data: "set_data",
            set_itemUpdater: "set_itemUpdater"
        })
    });
    nfuzion.widget.Label = function(name, component) {
        nfuzion.widget.Simple.call(this, name, component)
    };
    $hxClasses["nfuzion.widget.Label"] =
        nfuzion.widget.Label;
    ...
    nfuzion.widget.Label.prototype = $extend(nfuzion.widget.Simple.prototype, {
        ...
        set_wrap: function(wrap) {
            if (this.textComponent !=
                null) this.textComponent.set_wrap(wrap);
            return wrap
        },
        wrap: null,
        set_text: function(text) {
    ...
    nfuzion.widget.List.__name__ = ["nfuzion", "widget",
        "List"
    ];
    ...
    nfuzion.widget.List.prototype = $extend(nfuzion.widget.Group.prototype, {
        ...
        getPosition: function(point) {
            haxe.Log.trace("FATAL: getPosition from List.as must be overridden.", {
                fileName: "List.hx",
                lineNumber: 280,
                className: "nfuzion.widget.List",
        ...
        changeDataPosition: function(dataPosition) {
            ...
            if (this._dataPosition != dataPosition) {
                ...
                if (dataPosition < this._dataPosition && dataPosition + this.rows.length >= this._dataPosition) {
                    ...
                    this._dataPosition && dataPosition < this._dataPosition + this.rows.length) {
        ...
        findComponents: function(container) {
            ...
            while (_g1 < _g) {
                ...
                if (widgetNameArray.length >= 3 && widgetNameArray[0] == "row") {
                    ...
                    rows.push(new nfuzion.widget.type.ItemWidget(widget,
                        index))
                }
            }
            ...
            if (rows.length > 1) this.rowSize = rows[1].widget.implementation._y - rows[0].widget.implementation._y;
            else this.rowSize = rows[0].widget.implementation._height;
            ...
            var nameArray = rows[rows.length -
                1].widget.name.split("_");
        ...
        __properties__: $extend(nfuzion.widget.Group.prototype.__properties__, {
            set_visualPosition: "set_visualPosition",
            set_dataPosition: "set_dataPosition",
            get_dataPosition: "get_dataPosition",
            set_dataLength: "set_dataLength",
    ...
    nfuzion.widget.Scroller.prototype = $extend(nfuzion.widget.Group.prototype, {
        ...
        updatePopup: function() {
            if (this.popupWidget != null) {
                ...
                if (vPages >
                    this.popupPageThreshold || hPages > this.popupPageThreshold) {
        ...
        set_hProgress: function(value) {
            if (this.horizontalEnabled && this.progressIndicator != null) {
                ...
                this.progressIndicator.set_width((value - this.hMinimum) /
                    valueRange * this.progressWidth)
            }
            return value
        },
        ...
        set_progress: function(value) {
            if (this.verticalEnabled) this.set_vProgress(value);
            else this.set_hProgress(value);
            return value
        },
        get_progress: function() {
            if (this.verticalEnabled) return this.get_vProgress();
            else return this.get_hProgress()
        },
        ...
        onListPageSize: function(e) {
            if (this.verticalEnabled) this.onVListPageSize(e);
            else this.onHListPageSize(e)
        },
        ...
        set_pageSize: function(pageSize) {
            if (this.verticalEnabled) this.set_vPageSize(pageSize);
            else this.set_hPageSize(pageSize);
            return pageSize
        },
        get_pageSize: function() {
            if (this.verticalEnabled) return this.vPageSize;
            else return this.hPageSize
        },
        ...
        set_vMaximum: function(max) {
            if (max != this.vMaximum) {
                ...
                if (this.vMaximum -
                    this.vPageSize < this.get_vValue()) this.set_value(this.vMaximum - this.vPageSize);
                this.repaint()
            }
        ...
        onListLength: function(e) {
            var list = e.target;
            if (this.verticalEnabled) this.onVListLength(e);
            else this.onHListLength(e)
        },
        set_maximum: function(max) {
            if (this.verticalEnabled) this.set_vMaximum(max);
            else this.set_hMaximum(max);
            return max
        },
        get_maximum: function() {
            if (this.verticalEnabled) return this.vMaximum;
            else return this.hMaximum
        },
        ...
        set_minimum: function(min) {
            if (this.verticalEnabled) this.set_vMinimum(min);
            else this.set_hMinimum(min);
            return min
        },
        get_minimum: function() {
            if (this.verticalEnabled) return this.vMinimum;
            else return this.hMinimum
        },
        ...
        get_hValue: function() {
            if (this.roundValue) return Math.round(this.hValue);
            else return this.hValue
        },
        hValue: null,
        ...
        get_vValue: function() {
            if (this.roundValue) return Math.round(this.vValue);
            else return this.vValue
        },
        vValue: null,
        set_value: function(value) {
            if (this.verticalEnabled) this.set_vValue(value);
            else this.set_hValue(value);
            return value
        },
        get_value: function() {
            if (this.verticalEnabled) return this.get_vValue();
            else return this.get_hValue()
        },
        ...
        slideY: function(y) {
            if (this.height >= 0)
                if (y > this.bottom) y = this.bottom;
                else {
                    if (y < this.top) y = this.top
                } else
            if (y < this.bottom) y = this.bottom;
            else if (y > this.top) y = this.top;
        ...
        slideX: function(x) {
            ...
            if (x < this.right) x = this.right;
            else if (x > this.left) x = this.left;
        ...
        updateProgress: function() {
            ...
            if (this.progressIndicator != null && this.progressTracksThumb) {
                if (this.thumb != null) {
                    ...
                    var xValueRange = this.hMaximum -
                        this.hMinimum - this.hPageSize;
        ...
        updateButtons: function() {
            ...
            if (this.horizontalEnabled) {
                if (this.leftButton != null) this.leftButton.set_enabled(this.get_hValue() >
                    this.hMinimum);
        ...
        updateValue: function() {
            ...
            if (this.verticalEnabled) {
                ...
                if (valueRange < 0) valueRange = 0;
                if (this.track != null)
                    if (this.thumb != null) this.set_vValue((this.thumb._y - this.top) / this.height * valueRange + this.vMinimum);
                    else this.set_vValue(this.track.globalToLocal(this.touch).y / this.height * valueRange + this.vMinimum)
            }
            if (this.horizontalEnabled) {
                valueRange =
                    this.hMaximum - this.hMinimum - this.hPageSize;
                if (valueRange < 0) valueRange = 0;
                if (this.track != null)
                    if (this.thumb != null) this.set_hValue((this.thumb._x - this.left) / this.width * valueRange + this.hMinimum);
                    else this.set_hValue(this.track.globalToLocal(this.touch).x / this.width * valueRange + this.hMinimum)
            }
            this.updateButtons()
        },
        update: function() {
            ...
            if (this.hideIfUseless) {
                ...
                if (this.horizontalEnabled &&
                    this.hMaximum - this.hPageSize > this.hMinimum) useless = false;
            ...
            if (this.verticalEnabled) {
                ...
                if (valueRange < 0) valueRange = 0;
                if (this.thumb != null)
                    if (valueRange != 0 && this.height != 0) this.thumb.set_y((value - this.vMinimum) / valueRange * this.height + this.top);
                    else this.thumb.set_y(this.top)
            }
            if (this.horizontalEnabled) {
                value =
                    this.get_hValue();
                ...
                if (valueRange < 0) valueRange = 0;
                if (this.thumb != null)
                    if (valueRange != 0 && this.width != 0) this.thumb.set_x((value - this.hMinimum) / valueRange * this.width + this.left);
                    else this.thumb.set_x(this.left)
            }
            this.updateProgress();
            this.updateButtons()
        },
        ...
        findComponents: function(container) {
            ...
            this.verticalLine = this.getComponentChild(this.implementation,
                "verticalLine");
        ...
        __properties__: $extend(nfuzion.widget.Group.prototype.__properties__, {
            set_sensitiveTrack: "set_sensitiveTrack",
            set_hideIfUseless: "set_hideIfUseless",
            set_value: "set_value",
            get_value: "get_value",
            set_vValue: "set_vValue",
            get_vValue: "get_vValue",
            set_hValue: "set_hValue",
            get_hValue: "get_hValue",
            set_minimum: "set_minimum",
            get_minimum: "get_minimum",
            set_hMinimum: "set_hMinimum",
            set_vMinimum: "set_vMinimum",
            set_maximum: "set_maximum",
            get_maximum: "get_maximum",
            set_vMaximum: "set_vMaximum",
            set_hMaximum: "set_hMaximum",
            set_pageSize: "set_pageSize",
            get_pageSize: "get_pageSize",
            set_vPageSize: "set_vPageSize",
            set_hPageSize: "set_hPageSize",
            set_reportPeriod: "set_reportPeriod",
            get_reportPeriod: "get_reportPeriod",
            set_progress: "set_progress",
            get_progress: "get_progress",
            set_vProgress: "set_vProgress",
            get_vProgress: "get_vProgress",
            set_hProgress: "set_hProgress",
            get_hProgress: "get_hProgress",
            set_autoRepeatPeriod: "set_autoRepeatPeriod",
            set_autoRepeatDelay: "set_autoRepeatDelay",
            set_popupPageThreshold: "set_popupPageThreshold"
        })
    });
    ...
    nfuzion.widget.Slice.prototype = $extend(nfuzion.widget.Simple.prototype, {
        update: function() {
            ...
            if (this.right != null) this.right.setSquare(rightEdge,
        ...
        findComponents: function(container) {
            ...
            if (this.middle != null) {
                ...
                this.minWidth = this.implementation._width -
                    this.middle._width;
    ...
    nfuzion.widget.VBox = function(name, component) {
        nfuzion.widget.Group.call(this,
            name, component)
    };
    ...
    nfuzion.widget.VBox.prototype = $extend(nfuzion.widget.Group.prototype, {
        ...
        findChildWidgets: function(container) {
            nfuzion.widget.Group.prototype.findChildWidgets.call(this,
                container);
            var _g = 0,
                _g1 = this.children;
            while (_g < _g1.length) {
    ...
    nfuzion.widget.event.ButtonEvent.__name__ =
        ["nfuzion", "widget", "event", "ButtonEvent"];
    ...
    $hxClasses["nfuzion.widget.event.ChainEvent"] =
        nfuzion.widget.event.ChainEvent;
    ...
    nfuzion.widget.event.WidgetEvent =
        function(type, target, bubbles) {
            if (bubbles == null) bubbles = true;
            nfuzion.event.BubblingEvent.call(this, type, bubbles);
            this.target = target
    };
    ...
    peripheral.Peripheral.initialize = function() {
        ...
        try {
            peripheral.Peripheral.spanClient =
                new nfuzion.span.SpanClient(peripheral.Peripheral.urlRecord.value, null, "Cluster", "hmi");
            ...
            haxe.Log.trace("NOTICE: Invalid url. Using default.", {
                fileName: "Peripheral.hx",
                lineNumber: 57,
                className: "peripheral.Peripheral",
        ...
        if (peripheral.Peripheral.spanClient !=
            null) {
        ...
        peripheral.Peripheral.urlRecord.addEventListener("RecordEvent.change",
            peripheral.Peripheral.onUrlChange)
    };
    ...
    peripheral.Peripheral.useDefault = function() {
        peripheral.Peripheral.urlRecord.set_value("ws://192.168.1.15")
    };
    ...
    screen.Cluster = function(graphicsClassName, fillParent) {
        nfuzion.nTactic.core.Screen.call(this, graphicsClassName,
            fillParent)
    };
    ...
    screen.Cluster.prototype = $extend(nfuzion.nTactic.core.Screen.prototype, {
        ...
        blinkTimerRun: function(priority) {
            ...
            switch (_g.vehicle.turnSignal[1]) {
                ...
                case 1:
                    ...
                    peripheral.Peripheral.chime.setChime(nfuzion.message.chime.type.Chime.turnSignalClick,
                        1);
                    break;
                case 2:
        ...
        onNavDistance: function(e) {
            this.distanceToTargetLabel.set_text(Std.string(Math.round(peripheral.Peripheral.navigation.distance /
                160.9) / 10) + "\u02d8");
        ...
        onNavCancel: function(e) {
            ...
            this.distanceToTargetScroller.set_value(0);
        ...
        onTurnSignal: function(e) {
            ...
            switch (_g.vehicle.turnSignal[1]) {
                ...
                case 2:
                    if (this.blinkTimer == null) {
                        this.blinkTimer = new nfuzion.timer.Timer(0.5, 0);
                        this.blinkTimer.addEventListener("timer", $bind(this,
                            this.blinkTimerRun));
                        this.blinkTimer.start()
                    }
                    this.leftSignal.set_visible(false);
        ...
        onDistanceToEmpty: function(e) {
            this.distanceToEmptyLabel.set_text(Std.string(peripheral.Peripheral.vehicle.distanceToEmpty |
                0) + "\u02d8");
        ...
        addListeners: function() {
            ...
            this.attachListener(peripheral.Peripheral.vehicle,
                "fuel", $bind(this, this.onFuel));
            ...
            this.attachListener(peripheral.Peripheral.vehicle,
                "tractionControl", $bind(this, this.onTractionControl));
            ...
            this.attachListener(peripheral.Peripheral.navigation,
                "navigationCancel", $bind(this, this.onNavCancel));
            ...
            this.attachListener(peripheral.Peripheral.navigation,
                "navigationWaypoints", $bind(this, this.onNavWaypoints));
            ...
            this.attachListener(peripheral.Peripheral.vehicle,
                "started", $bind(this, this.onStarted));
        ...
        initializeScreen: function() {
            ...
            this.waterTemp =
                this.getWidget("waterTemp_scroller");
            ...
            this.waterTemp.set_maximum(1);
            this.waterTemp.set_minimum(0);
            this.waterTemp.set_pageSize(0);
            this.fuelLevel.set_maximum(1);
            this.fuelLevel.set_minimum(0);
            this.fuelLevel.set_pageSize(0);
            ...
            this.distanceToTargetScroller.set_maximum(1);
            this.distanceToTargetScroller.set_minimum(0);
            this.distanceToTargetScroller.set_pageSize(0);
        ...
        __properties__: $extend(nfuzion.nTactic.core.Screen.prototype.__properties__, {
            set_navAlpha: "set_navAlpha"
        })
    });
    ...
    screen.SpanConfigPopup.prototype = $extend(nfuzion.nTactic.core.DynamicScreen.prototype, {
        ...
        onHistorySelect: function(e) {
            var data =
                this.historyList.getDataByWidget(e.target);
            if (data != null) {
                this.entry = data;
        ...
        requestData: function(start, end) {
            ...
            this.historyList.cache.addData(new nfuzion.widget.type.PartialList(start,
                entries))
        },
        ...
        onConnectionEvent: function(e) {
            if (peripheral.Peripheral.spanClient.get_connected()) {
                haxe.Log.trace("Connected to Span!", {
                    fileName: "SpanConfigPopup.hx",
                    lineNumber: 484,
                    className: "screen.SpanConfigPopup",
                ...
                haxe.Log.trace("Connection Failed!", {
                    fileName: "SpanConfigPopup.hx",
                    lineNumber: 496,
                    className: "screen.SpanConfigPopup",
                    methodName: "onConnectionEvent"
        ...
        updateKeys: function(itemWidget) {
            if (js.Boot.__instanceof(itemWidget.widget, nfuzion.widget.Button)) {
                ...
                if (Lambda.indexOf(numerals, itemWidget.data.toUpperCase()) != -1) button.label.set_paint(this.numeralPaint);
                else button.label.set_paint(this.alphaPaint)
            }
        },
        createButton: function(foundation, name, font, staticText, verticalAlign, upPaint) {
            ...
            var textSketch = null;
            if (font != null) {
                var textHeight = Math.round(1.35 *
                    font.size);
        ...
        layoutScreen: function() {
            ...
            var screenRatio = 0.8;
            var popupWidth = 0.9 * screenWidth | 0;
            var popupHeight;
            if (screenRatio >= 0.5) popupHeight = 0.5 * popupWidth | 0;
            else popupHeight = screenRatio * popupWidth | 0;
            ...
            var close = this.createButton(controlPanel,
                "close_button", this.symbolFont, "X", 0.6, this.controlsPaint);
            ...
            while (_g < 4) {
                ...
                while (_g1 < 10) {
                    var x = _g1++;
                    var key =
                        this.createButton(keypad, "item_" + (x + y * 10) + "_button", this.keypadFont);
        ...
        defineFonts: function() {
            ...
            this.displayFontPrimary = this.setFont("spanconfigdisplayprimary", this.formatPath("./fonts/GillSansLight.ttf"),
                36);
        ...
        definePaints: function() {
            ...
            this.invalidPaint =
                this.setPaint("spanconfiginvalid", "0xff3300");
            ...
            this.bgPaint = this.setPaint("spanconfigbackground",
                "0x000000")
        },
        enterScreen: function() {
            ...
            this.deleteButton.set_autoRepeatDelay(0.5);
            this.deleteButton.set_autoRepeatPeriod(0.1);
            this.historyList.update();
            this.entry = peripheral.Peripheral.spanClient.url.toString();
            this.displayLabel.set_text(this.entry);
            this.onConnectionEvent();
            if (screen.SpanConfigPopup.keyLayouts.length > 1) this.keyboardButton.set_visible(true);
            else this.keyboardButton.set_visible(false);
            this.historyList.set_visible(false)
        },
        addListeners: function() {
            ...
            this.attachListener(this.closeButton,
                "ButtonEvent.click", $bind(this, this.onClose));
            ...
            this.attachListener(peripheral.Peripheral.spanClient, "SpanClientEvent.disconnect",
                $bind(this, this.onConnectionEvent))
        },
        setupWidgets: function() {
            ...
            this.displayLabel =
                this.getWidget("control_group.display_button.input_label");
            ...
            var _g1 = 0,
                _g = this.keyMatrix.get_childCount() - 1;
            while (_g1 < _g) {
                var i = _g1++;
            ...
            this.historyList.cache.set_dataRequester($bind(this,
                this.requestData));
    ...
    screen.Welcome.prototype = $extend(nfuzion.nTactic.core.Screen.prototype, {
        ...
        endGlow: function() {
            new nfuzion.tween.Tween(0.5, [new nfuzion.tween.type.TweenProperty(this.glow, "alpha", 0, nfuzion.tween.type.TweenType.slow)])
        },
        enterLines: function() {
            ...
            new nfuzion.tween.Tween(0.5, [new nfuzion.tween.type.TweenProperty(this.glow, "alpha", 1, nfuzion.tween.type.TweenType.fast)], $bind(this, this.endGlow));
        ...
        animationComplete: function() {
            haxe.Log.trace("Complete", {
                fileName: "Welcome.hx",
                lineNumber: 118,
                className: "screen.Welcome",
                methodName: "animationComplete"
            });
            this.setInitialState()
        },
        animate: function() {
            haxe.Log.trace("Animating!", {
                fileName: "Welcome.hx",
                lineNumber: 110,
                className: "screen.Welcome",
                methodName: "animate"
            ...
            new nfuzion.tween.Tween(0.5, [new nfuzion.tween.type.TweenProperty(this.welcomeText, "alpha", 1, nfuzion.tween.type.TweenType.slow)]);
            new nfuzion.timer.Delay($bind(this, this.enterLines), 0.75)
        },
        onWelcome: function(e) {
            if (peripheral.Peripheral.vehicle.welcomeSubtitle != null) this.nameLabel.set_text(peripheral.Peripheral.vehicle.welcomeSubtitle);
            else this.nameLabel.set_text("");
        ...
        onIgnition: function(e) {
            ...
            new nfuzion.timer.Delay($bind(this, this.fadeOut), 0.1)
        },
        addListeners: function() {
            nfuzion.nTactic.core.Screen.prototype.addListeners.call(this);
            this.attachListener(peripheral.Peripheral.vehicle,
                "welcome", $bind(this, this.onWelcome));
        ...
        enterScreen: function() {
            ...
            this.setInitialState();
            this.set_alpha(0);
            new nfuzion.timer.Delay($bind(this, this.fadeIn), 0.5)
        },
        initializeScreen: function() {
            nfuzion.nTactic.core.Screen.prototype.initializeScreen.call(this);
    ...
    nfuzion.graphics.event.StageEvent.PAINT =
        "paint";
    ...
    nfuzion.image.event.ImageLoaderEvent.COMPLETE =
        "ImageLoaderEvent.complete";
    ...
    nfuzion.message.debug.LetTrace.timestampType =
        [Float];
    ...
    nfuzion.message.generic.templates.SetBool.valueType =
        [Bool];
    ...
    nfuzion.message.leap.LetPoke.fingerCountType =
        [Int];
    ...
    nfuzion.message.leap.LetZoom.deltaZoomType =
        [Float];
    ...
    nfuzion.message.media.type.Item.artistType =
        [String];
    ...
    nfuzion.message.navigation.type.StepData.targetType =
        [nfuzion.message.navigation.type.TargetType];
    ...
    nfuzion.message.navigation.type.SerializablePoint.yType =
        [Float];
    ...
    nfuzion.message.navigation.type.Waypoint.xType =
        [Float];
    ...
    nfuzion.moduleLink.event.MediaPlayerEvent.AUDITION_PERIOD =
        "auditionPeriod";
    ...
    nfuzion.moduleLink.event.MediaPlayerEvent.TRANSPORT_POSITION =
        "transportPosition";
    ...
    nfuzion.moduleLink.event.VehicleEvent.AIR_BAG =
        "airBag";
    ...
    nfuzion.moduleLink.event.VehicleEvent.SPEED =
        "speed";
    ...
    nfuzion.nTactic.event.ScreenModelEvent.AFTER_GOTO =
        "afterGoto";
    ...
    nfuzion.physics.Scrolling.EXTREMITY_ACCELERATION = 2E4;
    nfuzion.physics.Scrolling.JERK = 200;
    nfuzion.physics.Scrolling.VELOCITY_KILL_TIME =
        0.1;
    ...
    nfuzion.span.SpanClient.RECONNECT_PERIOD =
        1;
    ...
    nfuzion.timer.Delay.BIG_NUMBER_NOT_INFINITY = 3.4E38;
    nfuzion.timer.Delay.delays = new Array;
    nfuzion.timer.Delay.requestedTimestamps =
        new Array;
    ...
    nfuzion.widget.event.ScrollerEvent.VERTICAL_POSITION =
        "ScrollerEvent.verticalPosition";
    ...
    screen.SpanConfigPopup.FILL_PERCENT = 0.9;
    ...
    screen.SpanConfigPopup.keyLayouts = [
        ["a", "b", "c", "d", "e", "f", "g", "7", "8", "9", "h", "i", "j", "k", "l", "m", "n", "4", "5", "6", "o", "p", "q", "r", "s", "t", "u", "1", "2", "3", "v", "w", "x", "y", "z", "-", ":", "/", "0", "."],
