...
nfuzion.geography.SphericalMercatorPosition.resolution = function(zoom) {
	return 156543.033928125 / Math.pow(2,zoom);
};
...
nfuzion.geography.SphericalMercatorPosition.prototype = $extend(nfuzion.geometry.Point.prototype,{
	...
	,__properties__: $extend(nfuzion.geometry.Point.prototype.__properties__,{set_longitude:"set_longitude",get_longitude:"get_longitude",set_latitude:"set_latitude",get_latitude:"get_latitude"})
});
...
nfuzion.graphics.BaseCanvas.prototype = {
	...
	,__properties__: {set_lineAlpha:"set_lineAlpha",set_linePaint:"set_linePaint",set_lineThickness:"set_lineThickness"}
};
nfuzion.relation = {};
...
$hxClasses["nfuzion.message.swc.LetCursor"] = nfuzion.message.swc.LetCursor;
nfuzion.message.swc.LetCursor.__name__ = ["nfuzion","message","swc","LetCursor"];
nfuzion.message.swc.LetCursor.__super__ = nfuzion.message.generic.templates.Let;
nfuzion.message.swc.LetCursor.prototype = $extend(nfuzion.message.generic.templates.Let.prototype,{
	x: null
	,y: null
	,phase: null
	,__class__: nfuzion.message.swc.LetCursor
});
...
nfuzion.message.swc.LetGesture = function(gesture) {
	nfuzion.message.generic.templates.Let.call(this);
	this.gesture = gesture;
};
$hxClasses["nfuzion.message.swc.LetGesture"] = nfuzion.message.swc.LetGesture;
nfuzion.message.swc.LetGesture.__name__ = ["nfuzion","message","swc","LetGesture"];
nfuzion.message.swc.LetGesture.__super__ = nfuzion.message.generic.templates.Let;
nfuzion.message.swc.LetGesture.prototype = $extend(nfuzion.message.generic.templates.Let.prototype,{
	gesture: null
	,__class__: nfuzion.message.swc.LetGesture
});
nfuzion.message.swc.LetRotate = function(deltaAngle,fingerCount) {
	nfuzion.message.generic.templates.Let.call(this);
	this.deltaAngle = deltaAngle;
	this.fingerCount = fingerCount;
};
$hxClasses["nfuzion.message.swc.LetRotate"] = nfuzion.message.swc.LetRotate;
nfuzion.message.swc.LetRotate.__name__ = ["nfuzion","message","swc","LetRotate"];
nfuzion.message.swc.LetRotate.__super__ = nfuzion.message.generic.templates.Let;
nfuzion.message.swc.LetRotate.prototype = $extend(nfuzion.message.generic.templates.Let.prototype,{
	deltaAngle: null
	,fingerCount: null
	,__class__: nfuzion.message.swc.LetRotate
});
nfuzion.message.swc.LetScroll = function(deltaX,deltaY,velocityX,velocityY,phase,fingerCount) {
	nfuzion.message.generic.templates.Let.call(this);
	this.deltaX = deltaX;
	this.deltaY = deltaY;
	this.velocityX = velocityX;
...
$hxClasses["nfuzion.message.swc.LetScroll"] = nfuzion.message.swc.LetScroll;
nfuzion.message.swc.LetScroll.__name__ = ["nfuzion","message","swc","LetScroll"];
nfuzion.message.swc.LetScroll.__super__ = nfuzion.message.generic.templates.Let;
nfuzion.message.swc.LetScroll.prototype = $extend(nfuzion.message.generic.templates.Let.prototype,{
	deltaX: null
	,deltaY: null
	,velocityX: null
	,velocityY: null
	,phase: null
	,fingerCount: null
	,__class__: nfuzion.message.swc.LetScroll
});
nfuzion.message.swc.LetTap = function(x,y,fingerCount,clickCount) {
	nfuzion.message.generic.templates.Let.call(this);
	this.x = x;
	this.y = y;
	this.fingerCount = fingerCount;
...
$hxClasses["nfuzion.message.swc.LetTap"] = nfuzion.message.swc.LetTap;
nfuzion.message.swc.LetTap.__name__ = ["nfuzion","message","swc","LetTap"];
nfuzion.message.swc.LetTap.__super__ = nfuzion.message.generic.templates.Let;
nfuzion.message.swc.LetTap.prototype = $extend(nfuzion.message.generic.templates.Let.prototype,{
	x: null
	,y: null
	,fingerCount: null
	,clickCount: null
	,__class__: nfuzion.message.swc.LetTap
});
nfuzion.message.swc.LetZoom = function(deltaZoom,fingerCount) {
	nfuzion.message.generic.templates.Let.call(this);
	this.deltaZoom = deltaZoom;
	this.fingerCount = fingerCount;
};
$hxClasses["nfuzion.message.swc.LetZoom"] = nfuzion.message.swc.LetZoom;
nfuzion.message.swc.LetZoom.__name__ = ["nfuzion","message","swc","LetZoom"];
nfuzion.message.swc.LetZoom.__super__ = nfuzion.message.generic.templates.Let;
nfuzion.message.swc.LetZoom.prototype = $extend(nfuzion.message.generic.templates.Let.prototype,{
	deltaZoom: null
	,fingerCount: null
	,__class__: nfuzion.message.swc.LetZoom
});
...
nfuzion.message.trauma = {};
nfuzion.message.trauma.GetLevel = function() {
	nfuzion.message.generic.templates.Get.call(this);
};
$hxClasses["nfuzion.message.trauma.GetLevel"] = nfuzion.message.trauma.GetLevel;
nfuzion.message.trauma.GetLevel.__name__ = ["nfuzion","message","trauma","GetLevel"];
nfuzion.message.trauma.GetLevel.__super__ = nfuzion.message.generic.templates.Get;
nfuzion.message.trauma.GetLevel.prototype = $extend(nfuzion.message.generic.templates.Get.prototype,{
	__class__: nfuzion.message.trauma.GetLevel
});
nfuzion.message.trauma.type = {};
nfuzion.message.trauma.type.TraumaLevel = $hxClasses["nfuzion.message.trauma.type.TraumaLevel"] = { __ename__ : ["nfuzion","message","trauma","type","TraumaLevel"], __constructs__ : ["none","low","high"] };
nfuzion.message.trauma.type.TraumaLevel.none = ["none",0];
nfuzion.message.trauma.type.TraumaLevel.none.toString = $estr;
nfuzion.message.trauma.type.TraumaLevel.none.__enum__ = nfuzion.message.trauma.type.TraumaLevel;
nfuzion.message.trauma.type.TraumaLevel.low = ["low",1];
nfuzion.message.trauma.type.TraumaLevel.low.toString = $estr;
nfuzion.message.trauma.type.TraumaLevel.low.__enum__ = nfuzion.message.trauma.type.TraumaLevel;
nfuzion.message.trauma.type.TraumaLevel.high = ["high",2];
nfuzion.message.trauma.type.TraumaLevel.high.toString = $estr;
nfuzion.message.trauma.type.TraumaLevel.high.__enum__ = nfuzion.message.trauma.type.TraumaLevel;
nfuzion.message.trauma.LetLevel = function(level) {
	nfuzion.message.generic.templates.Let.call(this);
	this.level = level;
};
$hxClasses["nfuzion.message.trauma.LetLevel"] = nfuzion.message.trauma.LetLevel;
nfuzion.message.trauma.LetLevel.__name__ = ["nfuzion","message","trauma","LetLevel"];
nfuzion.message.trauma.LetLevel.__super__ = nfuzion.message.generic.templates.Let;
nfuzion.message.trauma.LetLevel.prototype = $extend(nfuzion.message.generic.templates.Let.prototype,{
	level: null
	,__class__: nfuzion.message.trauma.LetLevel
});
nfuzion.message.tts = {};
...
nfuzion.moduleLink.ISwc = function() { };
$hxClasses["nfuzion.moduleLink.ISwc"] = nfuzion.moduleLink.ISwc;
nfuzion.moduleLink.ISwc.__name__ = ["nfuzion","moduleLink","ISwc"];
nfuzion.moduleLink.ISwc.__interfaces__ = [nfuzion.event.IEventDispatcher];
nfuzion.moduleLink.ISwc.prototype = {
	onLetCursor: null
	,onLetGesture: null
	,onLetRotate: null
	,onLetScroll: null
	,onLetTap: null
	,onLetZoom: null
	,__class__: nfuzion.moduleLink.ISwc
};
...
nfuzion.moduleLink.ITrauma = function() { };
$hxClasses["nfuzion.moduleLink.ITrauma"] = nfuzion.moduleLink.ITrauma;
nfuzion.moduleLink.ITrauma.__name__ = ["nfuzion","moduleLink","ITrauma"];
nfuzion.moduleLink.ITrauma.__interfaces__ = [nfuzion.moduleLink.IModuleLink];
nfuzion.moduleLink.ITrauma.prototype = {
	level: null
	,getLevel: null
	,__class__: nfuzion.moduleLink.ITrauma
};
...
nfuzion.moduleLink.MediaPlayer.prototype = $extend(nfuzion.moduleLink.ClientModuleLink.prototype,{
	...
	,invalidateCurrentData: function() {
		var $it0 = this.dataStates.iterator();
		while( $it0.hasNext() ) {
			var value = $it0.next();
			value = false;
		}
...
nfuzion.moduleLink.SwcProxy = function(client) {
	nfuzion.moduleLink.ClientModuleLink.call(this,client,"swc");
};
$hxClasses["nfuzion.moduleLink.SwcProxy"] = nfuzion.moduleLink.SwcProxy;
nfuzion.moduleLink.SwcProxy.__name__ = ["nfuzion","moduleLink","SwcProxy"];
nfuzion.moduleLink.SwcProxy.__interfaces__ = [nfuzion.moduleLink.ISwc];
nfuzion.moduleLink.SwcProxy.__super__ = nfuzion.moduleLink.ClientModuleLink;
nfuzion.moduleLink.SwcProxy.prototype = $extend(nfuzion.moduleLink.ClientModuleLink.prototype,{
	onLetCursor: function(message) {
		this.dispatchEvent(nfuzion.moduleLink.event.SwcEvent.createCursorEvent(message.x,message.y,message.phase));
	}
	,onLetGesture: function(message) {
		this.dispatchEvent(nfuzion.moduleLink.event.SwcEvent.createGestureEvent(message.gesture));
	}
	,onLetRotate: function(message) {
		this.dispatchEvent(nfuzion.moduleLink.event.SwcEvent.createRotateEvent(message.deltaAngle,message.fingerCount));
	}
	,onLetScroll: function(message) {
		this.dispatchEvent(nfuzion.moduleLink.event.SwcEvent.createScrollEvent(message.deltaX,message.deltaY,message.velocityX,message.velocityY,message.phase,message.fingerCount));
	}
	,onLetTap: function(message) {
		this.dispatchEvent(nfuzion.moduleLink.event.SwcEvent.createTapEvent(message.x,message.y,message.fingerCount,message.clickCount));
	}
	,onLetZoom: function(message) {
...
nfuzion.moduleLink.TraumaProxy = function(client) {
	nfuzion.moduleLink.ClientModuleLink.call(this,client,"trauma");
};
$hxClasses["nfuzion.moduleLink.TraumaProxy"] = nfuzion.moduleLink.TraumaProxy;
nfuzion.moduleLink.TraumaProxy.__name__ = ["nfuzion","moduleLink","TraumaProxy"];
nfuzion.moduleLink.TraumaProxy.__interfaces__ = [nfuzion.moduleLink.ITrauma];
...
nfuzion.moduleLink.TraumaProxy.prototype = $extend(nfuzion.moduleLink.ClientModuleLink.prototype,{
	...
	,level: null
	,getLevel: function() {
		this.sendMessage(new nfuzion.message.trauma.GetLevel());
	}
	,__class__: nfuzion.moduleLink.TraumaProxy
});
...
nfuzion.moduleLink.event.SwcEvent = function(type) {
	nfuzion.event.Event.call(this,type);
	this.x = 0;
	this.y = 0;
	this.phase = null;
...
$hxClasses["nfuzion.moduleLink.event.SwcEvent"] = nfuzion.moduleLink.event.SwcEvent;
nfuzion.moduleLink.event.SwcEvent.__name__ = ["nfuzion","moduleLink","event","SwcEvent"];
nfuzion.moduleLink.event.SwcEvent.createCursorEvent = function(x,y,phase) {
...
nfuzion.moduleLink.event.SwcEvent.createGestureEvent = function(gesture) {
	var event = new nfuzion.moduleLink.event.SwcEvent("swcGesture");
	event.gesture = gesture;
	return event;
};
nfuzion.moduleLink.event.SwcEvent.createRotateEvent = function(deltaAngle,fingerCount) {
	var event = new nfuzion.moduleLink.event.SwcEvent("swcRotate");
	event.deltaAngle = deltaAngle;
	event.fingerCount = fingerCount;
	return event;
};
nfuzion.moduleLink.event.SwcEvent.createScrollEvent = function(deltaX,deltaY,velocityX,velocityY,phase,fingerCount) {
	var event = new nfuzion.moduleLink.event.SwcEvent("swcCursor");
	event.deltaX = deltaX;
	event.deltaY = deltaY;
	event.velocityX = velocityX;
...
nfuzion.moduleLink.event.SwcEvent.createZoomEvent = function(deltaZoom,fingerCount) {
	var event = new nfuzion.moduleLink.event.SwcEvent("swcCursor");
	event.deltaZoom = deltaZoom;
	event.fingerCount = fingerCount;
	return event;
...
nfuzion.moduleLink.event.SwcEvent.prototype = $extend(nfuzion.event.Event.prototype,{
	...
	,clickCount: null
	,deltaZoom: null
	,__class__: nfuzion.moduleLink.event.SwcEvent
});
...
nfuzion.moduleLink.event.TraumaEvent = function(type) {
	nfuzion.event.Event.call(this,type);
};
$hxClasses["nfuzion.moduleLink.event.TraumaEvent"] = nfuzion.moduleLink.event.TraumaEvent;
nfuzion.moduleLink.event.TraumaEvent.__name__ = ["nfuzion","moduleLink","event","TraumaEvent"];
nfuzion.moduleLink.event.TraumaEvent.__super__ = nfuzion.event.Event;
nfuzion.moduleLink.event.TraumaEvent.prototype = $extend(nfuzion.event.Event.prototype,{
	__class__: nfuzion.moduleLink.event.TraumaEvent
});
...
nfuzion.widget.Map.prototype = $extend(nfuzion.widget.Group.prototype,{
	...
	,set_zoom: function(zoom) {
		if(this.zoom != zoom) {
			...
			var inCount = 0;
			var _g1 = 0;
			var _g = this.mapGrids.length - 1;
			while(_g1 < _g) {
				var i = _g1++;
				var mapGrid1 = this.mapGrids[i];
				var gridZoom;
				...
				mapGrid1.set_zoom(gridZoom);
				mapGrid1.set_scale(gridScale);
			}
			this.update();
		}
		return this.zoom;
	...
	,__properties__: $extend(nfuzion.widget.Group.prototype.__properties__,{set_zoom:"set_zoom",set_longitude:"set_longitude",set_latitude:"set_latitude",set_bufferRadius:"set_bufferRadius"})
});
...
nfuzion.widget.MapGrid.prototype = $extend(nfuzion.widget.Simple.prototype,{
	...
	,__properties__: $extend(nfuzion.widget.Simple.prototype.__properties__,{set_bufferRadius:"set_bufferRadius",set_scale:"set_scale",set_yMeters:"set_yMeters",set_xMeters:"set_xMeters",set_zoom:"set_zoom",set_gridSize:"set_gridSize"})
});
...
peripheral.ActionManager = function() {
	nfuzion.event.EventDispatcher.call(this);
	peripheral.Peripheral.navigation.getNextTurn();
};
...
peripheral.ActionManager.prototype = $extend(nfuzion.event.EventDispatcher.prototype,{
	performIntentAction: function(action) {
		if(peripheral.Peripheral.navigation.nextTurn == null && action.action == nfuzion.message.notice.type.ActionType.addWaypoint) action.action = nfuzion.message.notice.type.ActionType.setDestination;
		var _g = action.action;
		switch(_g[1]) {
		case 0:
...
peripheral.CommBacklog = function() {
	...
	peripheral.Peripheral.trauma.addEventListener("level",$bind(this,this.onTraumaLevel));
...
peripheral.CommBacklog.prototype = $extend(nfuzion.event.EventDispatcher.prototype,{
	...
	,generateRelativeTime: function(minutesAgo) {
		var now = new Date();
		var then;
		var t = now.getTime() - minutesAgo * 60000;
		var d = new Date();
		d.setTime(t);
		then = d;
	...
	,getCurrentEventData: function() {
		if(this.currentEvent != null) {
			haxe.Log.trace("dispatching event",{ fileName : "CommBacklog.hx", lineNumber : 93, className : "peripheral.CommBacklog", methodName : "getCurrentEventData"});
	...
	,onReady: function(e) {
		if(peripheral.Peripheral.notice.ready) {
			peripheral.Peripheral.notice.getCount();
			peripheral.Peripheral.trauma.getLevel();
		}
	}
	,onCount: function(e) {
		haxe.Log.trace("onCount " + peripheral.Peripheral.notice.get_count(),{ fileName : "CommBacklog.hx", lineNumber : 118, className : "peripheral.CommBacklog", methodName : "onCount"});
	...
	,showIntentItem: function(item) {
		if(this.popupModel.currentBranch == "") {
			...
			item.shown = true;
			var popupPriority = 0;
			var _g = this.popupNotice.priority;
			switch(_g[1]) {
			case 2:
				popupPriority = 0;
				break;
			...
			var traumaLevel = 0;
			if(peripheral.Peripheral.trauma.level != null) {
				var _g1 = peripheral.Peripheral.trauma.level;
				switch(_g1[1]) {
				case 0:
					traumaLevel = 0;
					break;
			...
			if(popupPriority >= traumaLevel) this.popupModel["goto"]("IntentPopup");
		}
	}
	,onTraumaLevel: function(e) {
		if(peripheral.Peripheral.trauma.level != null && this.popupNotice != null) {
			var popupPriority = 0;
			var _g = this.popupNotice.priority;
			switch(_g[1]) {
			case 2:
			...
			if(popupPriority < traumaLevel) this.popupModel["goto"]("");
		}
	}
	...
	,__properties__: {set_currentEvent:"set_currentEvent",set_popupNotice:"set_popupNotice"}
});
...
peripheral.HumanInput = function() {
	this.swcCursorLastQuantaTimestamp = 0;
	this.swcCursorAccumulation = 0;
...
peripheral.HumanInput.prototype = $extend(nfuzion.event.EventDispatcher.prototype,{
	...
	,swcCursorLastY: null
	,swcCursorAccumulation: null
	,swcCursorLastQuantaTimestamp: null
	,onSwcCursor: function(e) {
		var _g = e.phase;
		switch(_g[1]) {
		case 0:
			this.swcCursorLastY = e.y;
			this.swcCursorAccumulation = 0;
			this.swcCursorLastQuantaTimestamp = 0;
			break;
		case 1:case 2:
			this.swcCursorAccumulation += this.swcCursorLastY - e.y;
			this.swcCursorLastY = e.y;
			break;
		}
		var timeDelta = nfuzion.timer.Delay.now() - this.swcCursorLastQuantaTimestamp;
		if(timeDelta > 0.2) {
			if(this.swcCursorAccumulation > 0.05) {
				this.up();
				this.swcCursorAccumulation = 0;
				this.swcCursorLastQuantaTimestamp = nfuzion.timer.Delay.now();
			}
			if(this.swcCursorAccumulation < -0.05) {
				this.down();
				this.swcCursorAccumulation += 0.05;
				this.swcCursorLastQuantaTimestamp = nfuzion.timer.Delay.now();
			}
		}
	}
	,onSwcGesture: function(e) {
		var _g = e.gesture;
		switch(_g[1]) {
		case 0:
			this.switchPanels();
...
peripheral.Peripheral.initialize = function() {
	...
	try {
		...
		haxe.Log.trace("NOTICE: Invalid url. Using default.",{ fileName : "Peripheral.hx", lineNumber : 97, className : "peripheral.Peripheral", methodName : "initialize"});
	...
	if(peripheral.Peripheral.spanClient != null) {
		...
		peripheral.Peripheral.swc = new nfuzion.moduleLink.SwcProxy(peripheral.Peripheral.spanClient);
		peripheral.Peripheral.trauma = new nfuzion.moduleLink.TraumaProxy(peripheral.Peripheral.spanClient);
	}
...
screen.AppPanel.prototype = $extend(screen.FocusPanel.prototype,{
	...
	,initializeScreen: function() {
		...
		this.dividerSimple.implementation.set_layout(new nfuzion.layout.SnapParentEdgesOffset(true,true,false,false));
		this.bottomDividerPosition = this._height - 319 - this.dividerSimple.implementation._height;
	...
	,set_dividerPosition: function(dividerPosition) {
		if(this.dividerPosition != dividerPosition) {
			...
			if(dividerPosition < 700) this.dividerSimple.implementation.set_alpha(1); else {
				var alpha = 1 - (dividerPosition - 700) / (870 - 700);
...
screen.ChainPopup.prototype = $extend(screen.FocusScreen.prototype,{
	...
	,onAfterGoto: function(e) {
		var className;
		var _this = Type.getClassName(Type.getClass(this));
		className = HxOverrides.substr(_this,7,null);
...
screen.CommList.prototype = $extend(screen.FocusPanel.prototype,{
	...
	,formatTime: function(seconds) {
		...
		var secString;
		secString = leadingZero + (seconds == null?"null":"" + seconds);
		minutes = minutes % 60;
		if(minutes < 10) leadingZero = "0"; else leadingZero = "";
		var minString;
		minString = leadingZero + (minutes == null?"null":"" + minutes);
		return (hours == null?"null":"" + hours) + ":" + minString + ":" + secString;
	}
	,itemUpdater: function(item) {
		if(item.widgetIndex < this.visibleNotices) {
			...
			if(suffix == "Phone") {
				...
				timeText = StringTools.replace(timeText,"AM","˙");
				timeText = StringTools.replace(timeText,"PM","˚");
				timeLabel.set_text(timeText);
	...
	,heightChanged: function() {
		...
		if(this.panelChain != null) {
			...
			if(this.visibleNotices > 3) {
				var _g2 = this;
				var _g11 = _g2.visibleNotices;
				_g2.set_visibleNotices(_g11 - 1);
				_g11;
			}
		}
	}
...
screen.ContactsPopupPanel.prototype = $extend(nfuzion.nTactic.core.Screen.prototype,{
	...
	,updateFocus: function() {
		if(this.listChain != null && this.listChain.links != null) {
			var data = new Array();
			var _g1 = this.focusIndex - 5;
			var _g = this.focusIndex + 5 + 1;
			while(_g1 < _g) {
				var i = _g1++;
...
screen.IntentPopup.prototype = $extend(screen.ChainPopup.prototype,{
	...
	,enterScreen: function() {
		...
		var _g = 0;
		var _g1 = peripheral.Peripheral.backlog.popupNotice.options;
		while(_g < _g1.length) {
			var option = _g1[_g];
			++_g;
			var action;
...
screen.Main.prototype = $extend(screen.FocusScreen.prototype,{
	...
	,updatePanels: function() {
		...
		var _g = this;
		var _g1 = _g.rightPosition;
		_g.set_rightPosition(_g1 - 1);
		_g1;
		var _g2 = this;
		var _g11 = _g2.rightPosition;
		_g2.set_rightPosition(_g11 + 1);
		_g11;
	}
	,openRight: null
	...
	,__properties__: $extend(screen.FocusScreen.prototype.__properties__,{set_rightAlpha:"set_rightAlpha",set_leftAlpha:"set_leftAlpha",set_rightPosition:"set_rightPosition",set_openRight:"set_openRight"})
});
...
screen.MusicPlayer.prototype = $extend(screen.FocusPanel.prototype,{
	...
	,updateControls: function() {
		...
		case 1:
			var playIcon1 = "play";
			if(peripheral.Peripheral.pandora.transportAction == nfuzion.message.media.type.TransportAction.play) playIcon1 = "pause";
			this.controlChain.set_data(["pandora","list","next",playIcon1,"plus","like","dislike"]);
...
screen.Status.prototype = $extend(nfuzion.nTactic.core.Screen.prototype,{
	...
	,outsideTemperatureLabel: null
	,initializeScreen: function() {
		nfuzion.nTactic.core.Screen.prototype.initializeScreen.call(this);
		this.timeLabel = this.getWidget("time_label");
		this.batterySimple = this.getWidget("battery_simple");
		this.outsideTemperatureLabel = this.getWidget("outsideTemp_label");
		this.batteryLabel = this.getWidget("batteryLevel_label");
		...
		this.batteryLabel.set_text("80%");
		this.outsideTemperatureLabel.set_text("72°");
	...
	,onCharging: function(e) {
		...
		this.batteryLabel.set_text(peripheral.Peripheral.phone.chargeLevel * 100 + "%");
	}
	,onTimer: function(e) {
		var now = new Date();
		...
		now = new Date();
		now = DateTools.delta(now,2100000);
		hours = now.getHours() % 12;
		if(hours == 0) hours = 12;
		timeString = hours + DateTools.format(now,":%M");
		if(now.getHours() < 12) timeString += "˙"; else timeString += "˚";
		this.destinationTimeLabel.set_text(timeString);
	}
...
nfuzion.geography.SphericalMercatorPosition.INITIAL_RESOLUTION = 156543.033928125;
...
nfuzion.message.swc.LetGesture.gestureType = [nfuzion.message.swc.type.Gesture];
nfuzion.message.swc.LetRotate.deltaAngleType = [Float];
nfuzion.message.swc.LetRotate.fingerCountType = [Int];
nfuzion.message.swc.LetScroll.deltaXType = [Float];
nfuzion.message.swc.LetScroll.deltaYType = [Float];
nfuzion.message.swc.LetScroll.velocityXType = [Float];
nfuzion.message.swc.LetScroll.velocityYType = [Float];
nfuzion.message.swc.LetScroll.phaseType = [nfuzion.message.swc.type.Phase];
nfuzion.message.swc.LetScroll.fingerCountType = [Int];
nfuzion.message.swc.LetTap.xType = [Float];
nfuzion.message.swc.LetTap.yType = [Float];
nfuzion.message.swc.LetTap.fingerCountType = [Int];
nfuzion.message.swc.LetTap.clickCountType = [Int];
nfuzion.message.swc.LetZoom.deltaZoomType = [Float];
nfuzion.message.swc.LetZoom.fingerCountType = [Int];
...
nfuzion.message.trauma.LetLevel.levelType = [nfuzion.message.trauma.type.TraumaLevel];
...
nfuzion.moduleLink.event.SwcEvent.CURSOR = "swcCursor";
nfuzion.moduleLink.event.SwcEvent.GESTURE = "swcGesture";
nfuzion.moduleLink.event.SwcEvent.ROTATE = "swcRotate";
...
nfuzion.moduleLink.event.TraumaEvent.LEVEL = "level";
...
peripheral.HumanInput.SWC_CURSOR_QUANTA = 0.05;
peripheral.HumanInput.SWC_CURSOR_TIME = 0.2;
...
screen.AppPanel.SMALL_MUSIC_PLAYER_SIZE = 319;
